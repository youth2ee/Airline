...
<head>
	...
	<meta name="keywords" content="마이 아시아나,Asiana Airlines,Asiana,Airlines,Fly,Flight,Ticket,Booking,Travel,Trip,Vacation,Business,Reservation,Checkin,Boarding Pass,Passenger">
	<meta name="description" content="Asiana Airlines">
	<link rel="stylesheet" type="text/css" href="/C/pc/css/reset.css">
	<link rel="stylesheet" type="text/css" href='/C/pc/css/layout.css'>
	<link rel="stylesheet" type="text/css" href='/C/pc/css/common.css'>
	<link rel="stylesheet" type="text/css" href='/C/pc/css/flyasiana.css'>

	<title>마이 아시아나│아시아나항공</title> 
</head>
<body>
...
})(window,document,'script','https://ozimg.flyasiana.com/js/appinsightor.min.js','ne');

ne('https://eum.flyasiana.com/ne.nfl','nprd',{
	xhr: {use: true},
	onerror:true,
	E2E: {
		use: true,
	...
	<div class="inner">
		<div class="fav_link">
			<ul>
				...
				<li><a href="#none" onClick="action_logging_common('TOP_01'); cms.goToLink('/C/KR/KO/club/earn-mileage-mall?menuId=CM201802220000728447');">마일리지 적립몰</a></li>
			
				<li><a href="#none" onClick="action_logging_common('TOP_02'); cms.goToLink('http://dutyfree.flyasiana.com/ko', '_blank');">기내 면세점</a></li>
			
				<li>
					<a href="#none" id="corporatePlusGo" >기업우대</a>
		...
		<div class="util_menu">
			<ul>
				...
				<li>
					<a href="#none" onClick="action_logging_common('TOSP_05'); cms.goToLink('/C/KR/KO/event/index?menuId=CM201802220000728482');">이벤트</a>
				</li>
				<li>
					<a href='#none' onClick="action_logging_common('TOP_06'); cms.goToLink('/C/KR/KO/customer/main?menuId=CM201802220000728474');">고객서비스</a>
					<ul>
					
							<li><a href="#none" onclick="cms.goToLink('/C/KR/KO//customer/notice/list');">공지사항</a></li>
						
							<li><a href="#none" onclick="cms.goToLink('/C/KR/KO//customer/guidance/index');">자주찾는질문</a></li>
						
							<li><a href="#none" onclick="cms.goToLink('/C/KR/KO//customer/voc');">고객의 말씀</a></li>
						
							<li><a href="#none" onclick="cms.goToLink('/C/KR/KO//customer/form-download/list');">양식다운로드</a></li>
				...
				<li class="lang_select01">
					...
					<div class="layer_pop type2 right" id="layerLanguage" style="display:none; width:auto;min-height:135px;">
						...
						<div class="pop_cont01">
							...
							<div class="mar_to20">
								...
								<select id="lang" title="언어" style="width:160px;">
								</select>
				...
				<li><a href='#none' onClick="action_logging_common('TOP_04'); cms.goToLink('/C/KR/KO/logout.do');">로그아웃</a></li>
...
<header class="sub">
	...
	<div class="h_inner">
		...
		<h1 class="logo"><a href="#none" onClick="action_logging_common('GNB_01'); cms.goToLink('/C/KR/KO/index');"><span class="hidden">ASIANA AIRLINES</span></a></h1>
...
<nav id="nav">
	...
	<ul class="nav_list">
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728253"
					   target="_self"
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728254"
					   target="_self"
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728255"
					   target="_self"
					   data-id="CM201802220000728255">항공권 예약</a>
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728256"
					   target="_self"
					   data-id="CM201802220000728256">최저가 간편조회</a>
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728257"
					   target="_self"
					   data-id="CM201802220000728257">오즈드림페어</a>
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728260"
					   target="_self"
					   data-id="CM201802220000728260">신용카드 혜택</a>
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728261"
					   target="_self"
					   data-id="CM201802220000728261">예약 안내</a>
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728267"
					   target="_self"
					   data-id="CM201802220000728267">운임 안내</a>
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728270"
					   target="_self"
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728271"
					   target="_self"
					   data-id="CM201802220000728271">예약 내역</a>
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728272"
					   target="_self"
					   data-id="CM201802220000728272">항공권 구매 내역</a>
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728273"
					   target="_self"
					   data-id="CM201802220000728273">체크인</a>
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728274"
					   target="_self"
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728275"
					   target="_self"
					   data-id="CM201802220000728275">스케줄 조회</a>
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728276"
					   target="_self"
					   data-id="CM201802220000728276">출도착 조회</a>
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728277"
					   target="_self"
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728278"
					   target="_self"
					   data-id="CM201802220000728278">운항 노선</a>
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728279"
					   target="_self"
					   data-id="CM201802220000728279">여행 정보</a>
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201901160001126270"
					   target="_self"
					   data-id="CM201901160001126270">캐빈승무원 여행일기</a>
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201906280001141751"
					   target="_self"
					   data-id="CM201906280001141751">아시아도 아시아나!</a>
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728284"
					   target="_self"
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728285"
					   target="_self"
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728286"
					   target="_self"
					   data-id="CM201802220000728286">사전 체크인</a>
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728289"
					   target="_self"
					   data-id="CM201802220000728289">공항 체크인</a>
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201909240001147374"
					   target="_self"
					   data-id="CM201909240001147374">사전 좌석 배정</a>
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728296"
					   target="_self"
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728297"
					   target="_self"
					   data-id="CM201802220000728297">이용 안내</a>
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728298"
					   target="_self"
					   data-id="CM201802220000728298">위탁 수하물</a>
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728304"
					   target="_self"
					   data-id="CM201802220000728304">휴대 수하물</a>
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728306"
					   target="_self"
					   data-id="CM201802220000728306">수하물 계산기</a>
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728308"
					   target="_self"
					   data-id="CM201802220000728308">운송제한 물품</a>
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728309"
					   target="_self"
					   data-id="CM201802220000728309">수하물 보상</a>
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728312"
					   target="_self"
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728313"
					   target="_self"
					   data-id="CM201802220000728313">유아여행 안내</a>
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728316"
					   target="_self"
					   data-id="CM201802220000728316">혼자 여행하는 어린이/청소년</a>
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728319"
					   target="_self"
					   data-id="CM201802220000728319">임신 중 여행</a>
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728320"
					   target="_self"
					   data-id="CM201802220000728320">장애인 고객</a>
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728321"
					   target="_self"
					   data-id="CM201802220000728321">패밀리 서비스</a>
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728322"
					   target="_self"
					   data-id="CM201802220000728322">반려동물 동반</a>
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728325"
					   target="_self"
					   data-id="CM201802220000728325">의료도움이 필요한 고객</a>
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728328"
					   target="_self"
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728329"
					   target="_self"
					   data-id="CM201802220000728329">출입국 신고서</a>
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728330"
					   target="_self"
					   data-id="CM201802220000728330">미국 입출국 기록(I-94)전자열람</a>
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728331"
					   target="_self"
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728332"
					   target="_self"
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728333"
					   target="_self"
					   data-id="CM201802220000728333">공항 안내</a>
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728334"
					   target="_self"
					   data-id="CM201802220000728334">탑승수속 절차</a>
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728337"
					   target="_self"
					   data-id="CM201802220000728337">라운지 이용</a>
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728342"
					   target="_self"
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728343"
					   target="_self"
					   data-id="CM201802220000728343">클래스별안내</a>
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728358"
					   target="_self"
					   data-id="CM201802220000728358">기내식/음료</a>
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728363"
					   target="_self"
					   data-id="CM201802220000728363">기내서비스순서</a>
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728364"
					   target="_self"
					   data-id="CM201802220000728364">기내특별서비스</a>
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728367"
					   target="_self"
					   data-id="CM201802220000728367">기내유실물조회</a>
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728368"
					   target="_self"
					   data-id="CM201802220000728368">기내 엔터테인먼트</a>
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728371"
					   target="_self"
					   data-id="CM201802220000728371">기내지 ASIANA 모바일앱</a>
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728372"
					   target="_self"
					   data-id="CM201802220000728372">국제선 기내면세품</a>
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728373"
					   target="_self"
					   data-id="CM201802220000728373">국내선 기내통신 판매</a>
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728374"
					   target="_self"
					   data-id="CM201802220000728374">기내건강</a>
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728375"
					   target="_self"
					   data-id="CM201802220000728375">휴대용전자기기 사용안내</a>
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728376"
					   target="_self"
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728377"
					   target="_self"
					   data-id="CM201802220000728377">A380-800</a>
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728379"
					   target="_self"
					   data-id="CM201802220000728379">B747-400</a>
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728378"
					   target="_self"
					   data-id="CM201802220000728378">A350-900</a>
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728380"
					   target="_self"
					   data-id="CM201802220000728380">B777-200ER</a>
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728381"
					   target="_self"
					   data-id="CM201802220000728381">B767-300</a>
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728382"
					   target="_self"
					   data-id="CM201802220000728382">A330-300</a>
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201906120001140983"
					   target="_self"
					   data-id="CM201906120001140983">A321-neo</a>
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728383"
					   target="_self"
					   data-id="CM201802220000728383">A321-100/200</a>
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728384"
					   target="_self"
					   data-id="CM201802220000728384">A320-200</a>
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728386"
					   target="_self"
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728390"
					   target="_self"
					   data-id="CM201802220000728390">레그룸 좌석</a>
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201907300001143699"
					   target="_self"
					   data-id="CM201907300001143699">국내선 비즈니스 존</a>
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201907300001143700"
					   target="_self"
					   data-id="CM201907300001143700">프론트 존</a>
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201907300001143701"
					   target="_self"
					   data-id="CM201907300001143701">듀오 좌석</a>
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728388"
					   target="_self"
					   data-id="CM201802220000728388">이코노미 스마티움</a>
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728387"
					   target="_self"
					   data-id="CM201802220000728387">로얄 비즈니스</a>
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201901080001124226"
					   target="_self"
					   data-id="CM201901080001124226">업그레이드 스탠바이</a>
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728393"
					   target="_self"
					   data-id="CM201802220000728393">기내 Wi-Fi</a>
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728392"
					   target="_self"
					   data-id="CM201802220000728392">도움이 필요한 고객</a>
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728385"
					   target="_self"
					   data-id="CM201802220000728385">매직보딩패스</a>
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728394"
					   target="_self"
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728395"
					   target="_self"
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728396"
					   target="_self"
					   data-id="CM201802220000728396">회원안내</a>
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728403"
					   target="_self"
					   data-id="CM201802220000728403">특별 프로그램</a>
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728407"
					   target="_self"
					   data-id="CM201802220000728407">할인제휴사</a>
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728410"
					   target="_self"
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728411"
					   target="_self"
					   data-id="CM201802220000728411">아시아나항공</a>
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728416"
					   target="_self"
					   data-id="CM201802220000728416">스타얼라이언스/제휴항공사</a>
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201811260001094805"
					   target="_self"
					   data-id="CM201811260001094805">마일리지 적립몰</a>
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728420"
					   target="_self"
					   data-id="CM201802220000728420">금융(신용카드,환전)</a>
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728424"
					   target="_self"
					   data-id="CM201802220000728424">쇼핑</a>
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728421"
					   target="_self"
					   data-id="CM201802220000728421">여행(호텔,렌터카,여행자보험)</a>
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728425"
					   target="_self"
					   data-id="CM201802220000728425">라이프(통신,보험)</a>
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728426"
					   target="_self"
					   data-id="CM201802220000728426">누락마일리지적립</a>
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728429"
					   target="_self"
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728430"
					   target="_self"
					   data-id="CM201802220000728430">아시아나항공</a>
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728434"
					   target="_self"
					   data-id="CM201802220000728434">스타얼라이언스/제휴항공사</a>
		...
		<li>
					...
					<a onclick="action_logging_common_gnb(this);loadingOpen('entire'); return false;"
					   href="/C/KR/KO/menu/id/CM201802220000728439"
					   target="_self"
					   data-id="CM201802220000728439">마일리지사용몰</a>
...
<div class="nav_right">
	...
	<div class="myasiana_area">
			...
			<a href="#none" class="btn_myasiana" id="btnMyasiana" title="마이 아시아나">
				<span class="hidden">마이 아시아나</span>
				<span class="hidden">읽지 않은 새로운 알림</span></span>
		...
		<div class="hdlayer_wrap" id="layerMyasiana">
			...
			<div class="hdlayer">
					...
					<div class="myinfo_wrap">
						<div class="myinfo">
							...
							<div class="desc">
								...
								<span class="mem_number">OZ 776 699 818</span>
							</div>
						</div>
						<div class="detail_box">
							<dl>
								...
								<dd>
									<a class="mile_more" href="#none" onClick="action_logging_common('GNB_06_01'); cms.goToLink('/I/KR/KO/GetMileageDetail.do')">
										<span class="num">0</span><!--<span class="unit">M</span>-->
							...
							<dl>
								...
								<dd>
									<a class="data" href="#none" onClick="action_logging_common('GNB_06_02'); cms.goToLink('/I/KR/KO/ShowCouponList.do', '_post')">
				...
				<a href="#none" class="myasiana_close"><span class="hidden">마이아시아나 레이어 닫기</span></a>
			</div>
		</div>
	</div>
	
		<div class="search_area">
			<a href="#none" class="btn_search" title="검색"><span class="hidden">검색</span></a>
			<div class="hdlayer_wrap" id="layerSearch">
				...
				<div class="hdlayer">
					...
					<a href="#none" class="search_close"><span class="hidden">검색 레이어 닫기</span></a>
				</div>
			</div>
		</div>
...
<div class="location_bar">
	<div class="inner">
		<a href="/C/KR/KO/index" class="home"><span class="hidden">메인으로 이동</span></a>
		<ul class="loca_menulist">

			
			<li>
				
				<a href="#none" class="current"><span>마이 아시아나</span></a>
				<ul>
						
			<li>
				
						<a onclick="action_logging_common_nav(this); return false;"
						   href="/C/KR/KO/menu/id/CM201803060000729176"
						   target="_self">
							<span><b>마이 아시아나</b></span>
						</a>
			...
			<li>
						...
						<a onclick="action_logging_common_nav(this); return false;"
						   href="/C/KR/KO/menu/id/CM201803210000730425"
						   target="_self">
							<span>회원등급</span>
						</a>
			...
			<li>
						...
						<a onclick="action_logging_common_nav(this); return false;"
						   href="/C/KR/KO/menu/id/CM201802220000728467"
						   target="_self">
							<span>회원정보</span>
						</a>
			...
			<li>
						...
						<a onclick="action_logging_common_nav(this); return false;"
						   href="/C/KR/KO/menu/id/CM201802220000728468"
						   target="_self">
							<span>마일리지</span>
						</a>
			...
			<li>
						...
						<a onclick="action_logging_common_nav(this); return false;"
						   href="/C/KR/KO/menu/id/CM201802220000728469"
						   target="_self">
							<span>쿠폰함</span>
						</a>
			...
			<li>
						...
						<a onclick="action_logging_common_nav(this); return false;"
						   href="/C/KR/KO/menu/id/CM201802220000728470"
						   target="_self">
							<span>가족회원관리</span>
						</a>
			...
			<li>
						...
						<a onclick="action_logging_common_nav(this); return false;"
						   href="/C/KR/KO/menu/id/CM201802220000728471"
						   target="_self">
							<span>알림함</span>
						</a>
			...
			<li>
						...
						<a onclick="action_logging_common_nav(this); return false;"
						   href="/C/KR/KO/menu/id/CM201802220000728472"
						   target="_self">
							<span>간편예약설정</span>
						</a>
			...
			<li>
						...
						<a onclick="action_logging_common_nav(this); return false;"
						   href="/C/KR/KO/menu/id/CM201802220000728473"
						   target="_self">
							<span>이벤트 참여내역</span>
						</a>
		...
		<div class="box_share_pop toggle_event_wrap" id="snsArea" style="display:none;">
			<a href="#" class="btn_share42 btn_toggle_event" title="SNS 공유하기">공유하기</a>
			<div class="box_share_sns">
				<ul>
					
							<li><a href="#none" class="btn_facebook42" title="Facebook 공유하기 - 새창">Facebook</a></li>
							<li><a href="#none" class="btn_twitter42" title="Twitter 공유하기 - 새창">Twitter</a></li>
							<li><a href="#none" class="btn_kakaostory42" title="KakaoTalk 공유하기 - 새창">KakaoTalk</a></li>
	...
	<div class="sub_container" id="container">
		<div class="myasiana_wrap">
			<div class="my_info_wrap">
				<div class="top_my_info">
					<div class="my_left">
						<div class="my_info">

							<p class="my_name"><a href="#none" onclick="javascript:showMemberInformation();">임윤희님</a><span>IM YOONHEE</span></p>
			
							<div class="my_card">
								<p>
									<a href="#" onclick="javascript:showMemberGrade();">
										실버<span>776 699 818</span>
									</a>
								</p>
								<a href="#" class="btn_arrow" id="btn_barcodeCard">바코드</a> 
								<a href="#" class="btn_arrow" id="btn_qrCard">QR</a> 
								<a href="#" class="btn_arrow" id="btn_smsSend">SMS</a> 
							</div>
						</div>
						<div class="my_noti" id="div_feed">
							<h3>알림함<span>0</span></h3> 
							<a href="#" class="mileage_more" onclick="javascript:showFeedList();"><span class="hidden">알림함 더보기</span></a> 
							<ul>

								<li>수신된 알림이 없습니다. <br>다양한 서비스별 맞춤 알림을 설정해주세요.</li>
								
							</ul>
						</div>
					</div>
					<div class="my_center">
						<div class="all_mileage_graph">
							<div id="canvas-holder" style="width:295px; height:295px;">
								<canvas id="chart-area" style="width:295px; height:295px;">
							</div>
							<div class="txt_mile_wrap">

								<span class="txt_mile_all">총 잔여 마일리지</span> 

								<p class="num_mile_all">0</p>
								<a href="#" class="mileage_more" onclick="javascript:showMileageList('REST');"><span class="hidden">총 잔여 마일리지 더보기</span></a> 
							</div>
						</div>
						<div class="remark">
							<ul>
								<li class="ico_remark01">
									<span class="remark_name">아시아나항공 탑승</span> 
									<span class="remark_mile">0</span>
								</li>
								<li class="ico_remark02">
									<span class="remark_name">아시아나항공 외 탑승</span> 
									<span class="remark_mile">0</span>
								</li>
								<li class="ico_remark03">
									<span class="remark_name">일반 제휴 및 기타</span> 
									<span class="remark_mile">0</span>
								</li>
							</ul>
						</div>
					...
					<div class="my_right">
						<div class="mileage">
							<p class="tit">소멸 예정 마일리지</p> 
							<p class="num_mileage">0
								<a href="#" class="mileage_more" onclick="javascript:showMileageExpire();"><span class="hidden">소멸예정 마일리지 더보기</span></a> 
							</p>
						</div>
						<div class="mileage">
							<p class="tit">가족합산 마일리지</p> 
							<p class="num_mileage">0
								<a href="#" class="mileage_more" onclick="javascript:showFamilyMember('MILEAGE');"><span class="hidden">가족합산 마일리지 더보기</span></a> 
							</p>
						</div>

						<div class="mileage_graph">
							<p name="p_mileageGraph"></p>
							<span name="span_mileageGraph"></span>
							<div class="bar_graph">
								<p>
									<span class="bar_bg">
										<span class="hidden"></span>
									</span>
									<span class="bar_ing" style="width:10%">
										<span class="hidden">현재 마일리지 잔액</span> 
									</span>
								</p>
								<span name="span_barGraph"></span>
							</div>
						</div>
			...
			<div class="my_detail_wrap">
				<div class="bottom_my_info">
					<div class="my_detail_top">
						<div class="my_num_info">
							<ul>
								<li class="ico_coupon"><a href="#" onclick="javascript:showCouponList();"><span class="tit">쿠폰 현황</span><span class="num">0</span></a> 
								</li>
								<li class="ico_interest"><a href="#" onclick="javascript:showFavoriteRoute();"><span class="tit">관심노선</span><span class="num">0</span></a> 
								</li>
								<li class="ico_family"><a href="#" onclick="javascript:showFamilyMember('LIST');"><span class="tit">등록된 가족회원</span><span class="num">0</span></a> 
								</li>
							</ul>
						</div>
						<div class="my_gray_box">
							<p><a href="#" onclick="javascript:showReservationList();"><span>항공권 예약 현황</span></a></p> 
						</div>
					</div>

					<div class="my_detail_bottom">
						<div class="my_detail_left">
							<div class="txt_top" name="p_normalGradeInfo">
							등급 산정 마일리지를 
									<div class="tooltip_wrap">
									<a href="#none" class="btn_info">도움말</a>
									<div class="layer_tooltip" style="width: 740px; display: none;">
										<div class="inner">
											<p class="title">등급 산정 마일리지란?</p>
											<p class="fsz_16">아시아나클럽 우수회원 등급은 아시아나항공과 스타얼라이언스 항공편을 탑승 후 아시아나클럽에 적립한 마일리지와 제휴 신용카드를 사용하여 적립된 마일리지로 결정됩니다</p>
											
											<p class="fsz_16 mar_to15">단, 제휴 신용카드를 사용하여 적립된 마일리지는 등급별로 5천~2만5천마일까지만 등급 산정에 반영됩니다</p>
											
											<p class="fsz_16 mar_to40">등급별 제휴 마일리지 적용 상한</p>
											
											<table class="table_list mar_to20">
												<caption>
													<strong>예상 상세요금 내역 표</strong>
													

												<p>구분,제휴마일리지 적용 상한,골드,다이아몬드,다이아몬드플러스,다이아몬드 플러스 평생회원 및 플래티늄로 구성된 표입니다.</p></caption>
												...
												<thead>
													<tr>
														<th scope="col" class="taC">구분</th>
														<th scope="col" class="taC">제휴마일리지 적용 상한</th>
													</tr>
												</thead>
												<tbody>
													<tr>
														<th scope="row" class="taL">골드</th>
														<td class="taL">5,000</td>
													</tr>
													<tr>
														<th scope="row" class="taL">다이아몬드</th>
														<td class="taL">10,000</td>
													</tr>
													<tr>
														<th scope="row" class="taL">다이아몬드 플러스</th>
														<td class="taL">25,000</td>
													</tr>
													<tr>
														<th scope="row" class="taL">다이아몬드 플러스 평생회원 및 플래티늄</th>
														<td class="taL">평생 회원으로 아시아나항공과 스타얼라이언스 탑승마일로만 평가</td>
														
													</tr>
												</tbody>
											</table>
										</div>
										<a href="#none" class="tooltip_close"><span class="hidden">닫기</span></a>
									</div>
								</div>
									<br>
										<span class="col_brown">20,000마일</span> 추가 적립 또는 아시아나항공 <span class="col_brown">30회</span> 추가 탑승 시 <br><span class="col_red">골드회원</span>으로 승급됩니다.
								<button type="button" class="btn_XS white" onclick="javascript:showMileageUpgrade();">승급 마일리지 조회</button> 
							</div>
							<div class="my_grade_graph" id="div_normalGradeGraph">
								<div class="round_graph" id="div_mileGraph">
									<div class="graph_box col2">
										 
										<span class="graph_tobe to_dia"></span>
										
										<span class="graph_current" name="mileGraph">
											<div class="icon_graph">
												<span class="ico_person"><span class="hidden">현재위치</span></span> 
												<div class="hidden">
													<span name="cur_grade_desc"></span>에서
													<span name="next_grade_desc"></span>#0까지
												</div>
												
												<span class="txt_bulloon">
													+  20,000 마일 남음
												</span>
											</div>
										</span>
										
										<span class="txt txt_step1"></span>
										<span class="txt txt_step2">
										</span>
									</div>
								</div>
								<div class="round_graph" id="div_cntGraph">
									<div class="graph_box col2">
										 
										<span class="graph_tobe to_dia"></span>
										 
										<span class="graph_current" name="cntGraph">
											<div class="icon_graph">
												<span class="ico_person"><span class="hidden">현재위치</span></span> 
												<div class="hidden">
													<span name="cur_grade_desc"></span>에서
							...
							<div class="grade_type" id="div_specialGradeInfo" style="display: none;">
								<div id="div_platinumInfo">
									회원님께서는 최고 등급인<br><span class="col_brown2" name="span_platinumInfo">'플래티늄' 등급</span>에 달성하셨습니다.
									<p class="txt_desc">회원님께서는 실적과 관계없이 평생 자격이 유지됩니다.</p>
								</div>
								<div id="div_magicInfo">
									회원님께서는 <span class="col_brown2">'매직마일즈' 등급</span>입니다.
									<p class="txt_desc"><span class="col_brown2">매직마일즈</span> 회원 자격유지기간 동안은 실적에 의한 승급이 되지 않습니다.</p> 
								</div>
							</div>
							<div class="special_grade" id="div_specialGradeText" style="display: none;">
								<p class="txt_platinum" name="p_platinumText">플래티늄 회원</p> 
								<p class="txt_magicmiles" name="p_magicText">매직마일즈 회원</p> 
							</div>
						</div>
						<div class="my_detail_right">
							<div class="recen_noti">
								<h3>최근 마일리지 현황</h3> 
								<ul>

									<li class="no_data">
										최근 적립/소진한 마일리지가 없습니다.
									</li>
	

								</ul>
								<a href="#" class="recen_noti_more" onclick="javascript:showMileageList('RECENT');"><span class="hidden">최근 마일리지 현황 더보기</span></a> 
							</div>
							<div class="etc_box">
								<ul>
								
									<li class="icon_etc1"><a href="#" onclick="javascript:showMemberNameChange();"><span>회원성명 변경</span></a></li> 	
									<li class="icon_etc2"><a href="#" onclick="javascript:showMileageSave();"><span>누락 마일리지 적립</span></a></li> 			
									<li class="icon_etc3"><a href="#" onclick="javascript:showFavorite();"><span>간편 예약 설정</span></a></li> 			
									<li class="icon_etc4"><a href="#" onclick="javascript:showEventParticipation();"><span>이벤트 참여 내역</span></a></li> 	
								</ul>
							</div>
						</div>
					</div>
...
<dl>
	...
	<dd>
				...
				<ul>
					<li><a href="#none" onclick="action_logging_common('FOOTER_01'); cms.goToLink('/C/KR/KO/cms/contents/menu/CM201802220000728490');">아시아나항공 소개</a></li>
					<li><a href="#none" onclick="action_logging_common('FOOTER_01'); cms.goToLink('/C/KR/KO/cms/contents/menu/CM201802220000728511');">지속가능경영</a></li>
					<li><a href="#none" onclick="action_logging_common('FOOTER_01'); cms.goToLink('/C/KR/KO/company/pr-channel/news-release/list');">홍보채널</a></li>
				</ul>
				<ul>
					<li><a href="#none" onclick="action_logging_common('FOOTER_01'); cms.goToLink('/C/KR/KO/company/joint-flight/staraliance');">제휴 항공사</a></li>
					<li><a href="#none" onclick="action_logging_common('FOOTER_01'); cms.goToLink('/C/KR/KO/cms/contents/menu/CM201802220000728506');">사회공헌</a></li>
					<li><a href="#none" onclick="action_logging_common('FOOTER_01'); cms.goToLink('/C/KR/KO/contents/performance-results');">IR</a></li>
				</ul>
			
	</dd>
</dl>
<dl>
	<dt><a href="#none">약관 및 규정</a></dt>
	<dd>
		<ul>
			
				<li class="privacy_policy">
					<a href="/C/pc/ag/common/pdf/ISMS_certification_kor.pdf"
						target="_blank" title="정보보호관리체계인증마크 ISMS 13-064 (새창)" class="ico">
						<span class="hidden">정보보호관리체계인증마크 ISMS 13-064 (새창)</span>
					</a>
			
				<a href="#none" onclick="action_logging_common('FOOTER_02'); cms.goToLink('/C/KR/KO/company/terms/personal/homepage');">개인정보처리방침</a>
			</li>
			<li><a href="#none" onclick="action_logging_common('FOOTER_02'); cms.goToLink('/C/KR/KO/cms/contents/menu/CM201802220000728522');">운송 약관 및 고지사항</a></li>
		...
		<ul>
			<li><a href="#none" onclick="action_logging_common('FOOTER_01'); cms.goToLink('/C/KR/KO/company/terms/terms');">이용약관</a></li>
			<li><a href="#none" onclick="action_logging_common('FOOTER_01'); cms.goToLink('/C/KR/KO/cms/contents/menu/CM201802220000728397?layerId=asiana_rule');">아시아나클럽 규정</a></li>
...
<dl>
	<dt><a href="#none">기타안내</a></dt>
	<dd>
		
			<ul>
				<li><a href="#none" onclick="action_logging_common('FOOTER_03'); cms.goToLink('/C/KR/KO/cms/contents/menu/CM201802220000728527');">항공교통이용자 서비스계획</a></li>
				<li><a href="#none" onclick="action_logging_common('FOOTER_03'); cms.goToLink('/C/KR/KO/cms/contents/menu/CM201802220000728523');">소비자 안전정보 안내</a></li>
				<li><a href="#none" onclick="action_logging_common('FOOTER_03'); cms.goToLink('/C/KR/KO/etc/sitemap');">사이트 맵</a></li>
			</ul>
			<ul>
				<!--li><a href="#none" onclick="action_logging_common('FOOTER_01'); location.href='/C/KR/KO/common/file/download-static/damage-redress/Application_for_Damage_Redress.pdf';">피해 구제 계획</a></li-->
				<li><a href="#none" onclick="action_logging_common('FOOTER_03'); location.href='/C/KR/KO/common/file/download-static-file/damage-redress/pdf/Application_for_Damage_Redress';">피해 구제 계획</a></li>
				<li><a href="#none" onclick="action_logging_common('FOOTER_03'); cms.goToLink('/C/KR/KO/cms/contents/menu/CM201802220000728387');">유료 부가서비스</a></li>
				<li><a href="#none" onclick="action_logging_common('FOOTER_03'); cms.goToLink('/C/KR/KO/cms/contents/menu/CM201802220000728517');">광고 안내</a></li>
			</ul>
		...
		<div class="sns_wrap">
			<div class="fl">
				<a class="star_members" href="http://www.staralliance.com/ko/" target="_blank" rel="noopener noreferrer" title="새창" onclick="action_logging_common('FOOTER_04'); action_outLogging_common($(this).attr('href'));"><span class="hidden">A STAR ALLIANCE MEMBER</span></a>
			</div>
			<div class="fr">
				<ul class="sns_list">
	...
	<div class="copy_area">
		<p class="copy">&copy; ASIANA AIRLINES. All rights reserved.</p>
	...
	<div class="layer_wrap" id="barcodeCard">
		<div class="dim_layer"></div>
		<div class="layer_pop" style="width: 500px;">
			<div class="pop_cont">
				<h4>바코드 카드</h4> 
				<div class="barcode_wrap">
					<div class="mem_barcode_wrap silver barcodeDiv">
						<p class="barcode_top">
							<span class="hidden membershipCardName"></span>
						</p>
						<div class="mem_barcode_info">
							<p class="mem_barcode"><img id="image_barcode" alt="고객정보 바코드" style="width: 220px; height: 70px"/></p> 
							<p class="mem_name"></p>
							<p class="mem_num"></p>
				...
				<ul class="list_type3">
					<li>바코드 카드를 출력하여 이용하시면, 기존 플라스틱 카드와 동일하게 사용하실 수 있습니다.</li>
					
					<li>바코드 카드로 아시아나항공, 스타얼라이언스에서 제공하는 서비스 및 제휴사의 서비스 혜택을 받으실 수 있습니다.</li>
					
				</ul>
			</div>
			<div class="btn_wrap_ceType2">
				<button type="button" class="btn_M white" onclick="MembershipCardPrint('Barcode');">바코드 카드 인쇄하기</button> 
				<button type="button" class="btn_M red" onclick="MembershipCardDownload('Barcode');">바코드 카드 저장하기</button> 
			</div>
			<a href="#none" class="dim_close"><span class="hidden">닫기</span></a> 
		</div>
	</div>
	
	<div class="layer_wrap" id="qrCard">
		<div class="dim_layer"></div>
		<div class="layer_pop" style="width: 500px;">
			<div class="pop_cont">
				<h4>QR 카드</h4> 
				<div class="barcode_wrap">
					<div class="mem_barcode_wrap silver qrcodeDiv">
						<p class="barcode_top">
							<span class="hidden membershipCardName"></span>
						</p>
						<div class="mem_barcode_info">
							<p class="mem_barcode"><img id="image_qr" alt="고객정보 QR코드" style="width: 120px; height: 120px"/></p> 
							<p class="mem_name"></p>
							<p class="mem_num"></p>
				...
				<ul class="list_type3">
					<li>QR 카드를 출력하여 이용하시면, 기존 플라스틱 카드와 동일하게 사용 하실 수 있습니다.</li>
					
					<li>QR 카드로 아시아나항공, 스타얼라이언스에서 제공하는 서비스 및 제휴사의 서비스 혜택을 받으실 수 있습니다.</li>
					
				</ul>
			</div>
			<div class="btn_wrap_ceType2">
			<button type="button" class="btn_M white" onclick="MembershipCardPrint('QRCode');">QR카드 인쇄하기</button> 		
				<button type="button" class="btn_M red" onclick="MembershipCardDownload('QRCode');">QR카드 저장하기</button> 
			</div>
			<a href="#none" class="dim_close"><span class="hidden">닫기</span></a> 
		</div>
	</div>
	
	<div class="layer_wrap" id="smsSend">
		<div class="dim_layer"></div>
		<div class="layer_pop" style="width:600px;">
			<div class="pop_cont">
				<p class="pop_tit">회원님의 휴대전화번호를 확인해주시기 바랍니다.</p> 
				<ul class="list_type3 mar_to20">
				
					<li>휴대전화 번호 : 82-010-4735-2699</li> 
				</ul>
				<p class="pop_tit st3">사용중이신 휴대전화번호와 상이할 경우 ‘회원정보 변경’에서 변경 후 사용해주시기 바랍니다.</p> 
			</div>
			<div class="btn_wrap_ceType2">
				<button type="button" class="btn_M white" onclick="javascript:showMemberInformationChange();">회원정보 변경</button> 
				<button type="button" class="btn_M red" onclick="javascript:sendAcnoBySMS();">기존 번호 사용</button> 
			</div>
			<a href="#none" class="dim_close"><span class="hidden">닫기</span></a> 
		</div>
	</div>
	...
	<form id="form_goto" name="form_goto" method="post">
		<input type="hidden" name="searchTab" value=""/>
	</form>
	<form id="form_coupon" name="form_coupon" method="post">
		<input type="hidden" name="couponType" value="ONLINE"/>
		<input type="hidden" name="tabType" value="DOWNLOAD"/>
	</form>
	<form name="imgForm" id="imgForm" action="DownloadQRCodeCard.do" method="post">
        <input type="hidden" id="imgData" name="imgData"/>
        <input type="hidden" id="acno" name="acno" value="776699818"/>
    </form>

	<script type="text/javascript" src="/C/pc/js/jquery-2.1.4.min.js"></script>
	
<div id="_dummy-coupon" style="display: none;">JSESSIONID%3D46c22dade6e543a28431a8c587786e2541d7962b9364fd3cc95d%21345378059%3B+domain%3D.flyasiana.com%3B+path%3D%2F%3B+secure%3B+HttpOnly</div>
...
<meta name="PCCM201804030000731200_41" content="인터넷 브라우저에서 팝업차단 해제바랍니다." />
...
<meta name="PCCM201804030000731200_50" content="* 아시아나항공은 고객님이 입력하신 정보(이름, 이메일, 전하는 내용)를 수집하지 않습니다." />
...
<meta name="PCCM201802220000728520_00_15" content="처리 중 오류가 발생하였습니다. 다시 시도하거나 관리자에게 문의바랍니다." />
<meta name="PCCM201802220000728520_00_16" content="조회하신 단어와 일치하는 게시물이 없습니다." />
<meta name="PCCM201802220000728520_00_17" content="게시물이 없습니다." />
<meta name="PCCM201802220000728520_00_18" content="서비스가 불안정합니다. 다시 시도해 주세요." />
...
<script type="text/javascript">
	...
	* */
	...
	<script type="text/javascript" src="/C/pc/js/chart.js"></script>
	<script type="text/javascript" src="/C/pc/js/chartUtils.js"></script>
	<script type="text/javascript" src="/C/pc/js/login.js"></script>
	...
	<script type="text/javascript" src="/js/common/bluebird.min.js"></script>
	<script type="text/javascript" src="/js/common/html2canvas.js" ></script>
	...
	<script type="text/javascript">
		...
		var memberName = "IM/YOONHEE";
		var memberAcno = "776699818";
		var currencyCipher = "";
		var countryCode = "KR";

		var asianaMileage = Number("0");
		var exceptAsianaMileage = Number("0");
		var etcMileage = Number("0");

		var totalMileage = asianaMileage + exceptAsianaMileage + etcMileage;
		...
		$(document).ready(function(){
			...
			$(document).on('click', '#btn_barcodeCard', function(){
				action_logging({pagecode:"09_DASH_01"});

				$("#image_barcode").prop("src", "GetBarcodeCard.do?membershipCardData=LSS6sNuIRpPIVUhFsSLF/A==");

				var name = checkNameLength();
				$("#barcodeCard").find(".mem_name").html(name);
				$("#barcodeCard").find(".mem_num").html("<span>"+memberAcno.substring(0,3)+" "+memberAcno.substring(3,6)+" "+memberAcno.substring(6,9)+"</span>");

				openLayerPopup("barcodeCard","");
			});

			
			$(document).on('click', '#btn_qrCard', function(){
				action_logging({pagecode:"09_DASH_QR"});

				$("#image_qr").prop("src","GetQRCard.do?membershipCardData=LSS6sNuIRpPIVUhFsSLF/A==");

				var name = checkNameLength();
				$("#qrCard").find(".mem_name").html(name);
				$("#qrCard").find(".mem_num").html("<span>"+memberAcno.substring(0,3)+" "+memberAcno.substring(3,6)+" "+memberAcno.substring(6,9)+"</span>");

				openLayerPopup("qrCard","");
			});

			
			$(document).on('click', '#btn_smsSend', function(){
				action_logging({pagecode:"09_DASH_02"});

				openLayerPopup("smsSend","");
			});

			
			$(document).on('click', '.unread', function(){
				var feedSeqNo = $(this).attr('seqno');

				$.ajax({
					async: false,
					url: "UpdateFeedReadYn.do",
					type: "post",
					dataType: 'json',
					data : {
						seqNo : feedSeqNo,
		...
		function checkNameLength(){
			var testName = memberName;

			if(testName.length > 20){
				var nameArr = testName.split('/');
				var lastName, firstName;

				if(nameArr[0].length > 20){
					lastName = nameArr[0].substring(0,18) + "..";
				}else{
					lastName = nameArr[0];
				}

				if(nameArr[1].length > 20){
					firstName = nameArr[1].substring(0,18) + "..";
				}else{
					firstName = nameArr[1];
				}

				testName = lastName+"<br>/"+firstName;
			}

			return testName;
		}

		function setMileageGraph(){
			...
			if(countryCode == "KR"){
				...
				var userMileage = "0";
				var maxMileage = "5000";
				var restMileage = Number(maxMileage) - Number(userMileage);
	
				if(restMileage > 0){
					var graphPercent = userMileage/maxMileage*100;
	
					$(".mileage_graph").find("p[name=p_mileageGraph]").html("<strong>#0 마일</strong>추가 적립 시".replace('#0', restMileage.setComma()));								
					$(".mileage_graph").find("span[name=span_mileageGraph]").html("["+cabinClass+"]<br>"+"#0탑승 가능합니다.(비수기/편도기준)".replace('#0', route+"<br>"));			
					$(".mileage_graph").find(".bar_bg").find("span").html("마일리지 #0점 기준".replace('#0', maxMileage.setComma()));								
					$(".mileage_graph").find("span[name=span_barGraph]").html("현재 <em>"+userMileage.setComma()+"/"+maxMileage.setComma()+"</em>");	
	
					$(".mileage_graph").find(".bar_ing").css('width', graphPercent+'%');
				}else{
					$(".mileage_graph").find("p[name=p_mileageGraph]").html("<strong>회원님의 마일리지로<strong>");													
					$(".mileage_graph").find("span[name=span_mileageGraph]").html("["+cabinClass+"]<br>"+"#0탑승 가능합니다.(비수기/편도기준)".replace('#0', route+"<br>"));			
					$(".mileage_graph").find(".bar_bg").find("span").html("마일리지 #0점 기준".replace('#0', maxMileage.setComma()));								
					$(".mileage_graph").find("span[name=span_barGraph]").html("현재 <em>"+userMileage.setComma()+"/"+maxMileage.setComma()+"</em>");	
	
					$(".mileage_graph").find(".bar_ing").css('width', '100%');
				}
			}

			var curMemberGrade      = "S";
			var curMemberGradeDesc  = "실버";
			var nextMemberGrade     = "G";
			var nextMemberGradeDesc = "골드";
			var datePeriod1 = "2020"+"/"+"01"+"/"
			+"17";
			var datePeriod2 = "2022"+"/"+"01"+"/"
			+"31";
			
			
			if(curMemberGrade == "P" || curMemberGrade == "K"){
				if(curMemberGrade == "P"){
					$("#div_platinumInfo").show();
					$("#div_magicInfo").hide();
					
					$("p[name=p_platinumText]").show();
					$("p[name=p_magicText]").hide();
				}else if(curMemberGrade == "K"){
					$("#div_platinumInfo").hide();
					$("#div_magicInfo").show();
					
					$("p[name=p_platinumText]").hide();
					$("p[name=p_magicText]").show();
				}

				$("p[name=p_normalGradeInfo]").hide();
				$("#div_normalGradeGraph").hide();
				$("#div_specialGradeInfo").show();
				$("#div_specialGradeText").show();
			}else{
				
				if(curMemberGrade == "S"){
					$("#div_mileGraph").find('.txt_step1').addClass('ico_silver');
					$("#div_cntGraph").find('.txt_step1').addClass('ico_silver');
					$("#div_mileGraph").find('.txt_step1').html(curMemberGradeDesc + '<strong class="my_grade_date">' + datePeriod1 +'</strong>');
					$("#div_cntGraph").find('.txt_step1').html(curMemberGradeDesc + '<strong class="my_grade_date">' + datePeriod1 +'</strong>');

					$("#div_mileGraph").find('.txt_step2').addClass('ico_gold');
					$("#div_cntGraph").find('.txt_step2').addClass('ico_gold');
					$("#div_mileGraph").find('.txt_step2').html(nextMemberGradeDesc  + '<strong class="my_grade_date">' + datePeriod2 +'</strong>');
					$("#div_cntGraph").find('.txt_step2').html(nextMemberGradeDesc + '<strong class="my_grade_date">' + datePeriod2 +'</strong>');
					
				}else if(curMemberGrade == "G"){
					$("#div_mileGraph").find('.txt_step1').addClass('ico_gold');
					$("#div_cntGraph").find('.txt_step1').addClass('ico_gold');
					$("#div_mileGraph").find('.txt_step1').html(curMemberGradeDesc + '<strong class="my_grade_date">' + datePeriod1 +'</strong>');
					$("#div_cntGraph").find('.txt_step1').html(curMemberGradeDesc + '<strong class="my_grade_date">' + datePeriod1 +'</strong>');

					$("#div_mileGraph").find('.txt_step2').addClass('icon_dia');
					$("#div_cntGraph").find('.txt_step2').addClass('icon_dia');
					$("#div_mileGraph").find('.txt_step2').html(nextMemberGradeDesc + '<strong class="my_grade_date">' + datePeriod2 +'</strong>');
					$("#div_cntGraph").find('.txt_step2').html(nextMemberGradeDesc + '<strong class="my_grade_date">' + datePeriod2 +'</strong>');
					
				}else if(curMemberGrade == "D"){
					$("#div_mileGraph").find('.txt_step1').addClass('icon_dia');
					$("#div_cntGraph").find('.txt_step1').addClass('icon_dia');
					$("#div_mileGraph").find('.txt_step1').html(curMemberGradeDesc + '<strong class="my_grade_date">' + datePeriod1 +'</strong>');
					$("#div_cntGraph").find('.txt_step1').html(curMemberGradeDesc + '<strong class="my_grade_date">' + datePeriod1 +'</strong>');

					$("#div_mileGraph").find('.txt_step2').addClass('ico_dia_plus');
					$("#div_cntGraph").find('.txt_step2').addClass('ico_dia_plus');
					$("#div_mileGraph").find('.txt_step2').html(nextMemberGradeDesc + '<strong class="my_grade_date">' + datePeriod2 +'</strong>');
					$("#div_cntGraph").find('.txt_step2').html(nextMemberGradeDesc + '<strong class="my_grade_date">' + datePeriod2 +'</strong>');
				}else if(curMemberGrade == "M"){
					$("#div_mileGraph").find('.txt_step1').addClass('ico_dia_plus');
					$("#div_cntGraph").find('.txt_step1').addClass('ico_dia_plus');
					$("#div_mileGraph").find('.txt_step1').html(curMemberGradeDesc + '<strong class="my_grade_date">' + datePeriod1 +'</strong>');
					$("#div_cntGraph").find('.txt_step1').html(curMemberGradeDesc + '<strong class="my_grade_date">' + datePeriod1 +'</strong>');

					$("#div_mileGraph").find('.txt_step2').addClass('ico_dia_plus');
					$("#div_cntGraph").find('.txt_step2').addClass('ico_dia_plus');
					$("#div_mileGraph").find('.txt_step2').html(nextMemberGradeDesc);
					$("#div_cntGraph").find('.txt_step2').html(nextMemberGradeDesc);
				}else if(curMemberGrade == "A"){
					$("#div_mileGraph").find('.txt_step1').addClass('ico_dia_plus');
					$("#div_cntGraph").find('.txt_step1').addClass('ico_dia_plus');
					$("#div_mileGraph").find('.txt_step1').html(curMemberGradeDesc);
					$("#div_cntGraph").find('.txt_step1').html(curMemberGradeDesc);

					$("#div_mileGraph").find('.txt_step2').addClass('ico_platinum');
					$("#div_cntGraph").find('.txt_step2').addClass('ico_platinum');
					$("#div_mileGraph").find('.txt_step2').html(nextMemberGradeDesc);
					$("#div_cntGraph").find('.txt_step2').html(nextMemberGradeDesc);
				}
				...
				if(milePercent <= 10){
					$("span[name=mileGraph]").addClass("step01");
				}else if(milePercent > 10 && milePercent <= 20){
					$("span[name=mileGraph]").addClass("step02");
				}else if(milePercent > 20 && milePercent <= 30){
					$("span[name=mileGraph]").addClass("step03");
				}else if(milePercent > 30 && milePercent <= 40){
					$("span[name=mileGraph]").addClass("step04");
				}else if(milePercent > 40 && milePercent <= 50){
					$("span[name=mileGraph]").addClass("step05");
				}else if(milePercent > 50 && milePercent <= 60){
					$("span[name=mileGraph]").addClass("step06");
				}else if(milePercent > 60 && milePercent <= 70){
					$("span[name=mileGraph]").addClass("step07");
				}else if(milePercent > 70 && milePercent <= 80){
					$("span[name=mileGraph]").addClass("step08");
				}else if(milePercent > 80 && milePercent <= 90){
					$("span[name=mileGraph]").addClass("step09");
					$("span[name=mileGraph]").find(".txt_bulloon").addClass("right");
				}else if(milePercent > 90){
					$("span[name=mileGraph]").addClass("step10");
					$("span[name=mileGraph]").find(".txt_bulloon").addClass("right");
				}
				
				if(cntPercent <= 10){
					$("span[name=cntGraph]").addClass("step01");
				}else if(cntPercent > 10 && cntPercent <= 20){
					$("span[name=cntGraph]").addClass("step02");
				}else if(cntPercent > 20 && cntPercent <= 30){
					$("span[name=cntGraph]").addClass("step03");
				}else if(cntPercent > 30 && cntPercent <= 40){
					$("span[name=cntGraph]").addClass("step04");
				}else if(cntPercent > 40 && cntPercent <= 50){
					$("span[name=cntGraph]").addClass("step05");
				}else if(cntPercent > 50 && cntPercent <= 60){
					$("span[name=cntGraph]").addClass("step06");
				}else if(cntPercent > 60 && cntPercent <= 70){
					$("span[name=cntGraph]").addClass("step07");
				}else if(cntPercent > 70 && cntPercent <= 80){
					$("span[name=cntGraph]").addClass("step08");
				}else if(cntPercent > 80 && cntPercent <= 90){
					$("span[name=cntGraph]").addClass("step09");
					$("span[name=cntGraph]").find(".txt_bulloon").addClass("right");
				}else if(cntPercent > 90){
					$("span[name=cntGraph]").addClass("step10");
					$("span[name=cntGraph]").find(".txt_bulloon").addClass("right");
				}

				$("p[name=p_normalGradeInfo]").show();
				$("#div_normalGradeGraph").show();
				$("#div_specialGradeInfo").hide();
				$("#div_specialGradeText").hide();

				$("span[name=cur_grade_desc]").html(curMemberGradeDesc);
				$("span[name=next_grade_desc]").html(nextMemberGradeDesc);
			}
		}

		
		function setMembershipCard(){
			var memberGrade = "S";

			if(memberGrade == "S"){
				$(".mem_barcode_wrap").addClass("silver");
				$(".membershipCardName").html("Asiana Club Silver");
			}else if(memberGrade == "K"){
				$(".mem_barcode_wrap").addClass("magicmiles");
				$(".membershipCardName").html("Asiana Club MagicMilese");
			}else if(memberGrade == "G"){
				$(".mem_barcode_wrap").addClass("gold");
				$(".membershipCardName").html("Asiana Club Gold");
			}else if(memberGrade == "D"){
				$(".mem_barcode_wrap").addClass("dia");
				$(".membershipCardName").html("Asiana Club Diamond");
			}else if(memberGrade == "M" || memberGrade == "A"){
				$(".mem_barcode_wrap").addClass("dia_plus");
				$(".membershipCardName").html("Asiana Club Diamond Plus");
			}else if(memberGrade == "P"){
				$(".mem_barcode_wrap").addClass("platinum");
				$(".membershipCardName").html("Asiana Club Platinum");
			}
		}

		
		function MembershipCardPrint(cardType){
			var selectObj;
			if(cardType == "Barcode"){
				selectObj = $("#barcodeCard");
			}else{
				selectObj = $("#qrCard");
			}

			$("#wrap").hide();
			var beforeTop = selectObj.find('.layer_pop').css('top');
			var beforeTitle = $(document).attr("title");
			$(document).attr("title", "카드 발급"); 
			selectObj.find('.layer_pop').css('top', '10px');
			selectObj.find(".dim_layer").css("background","white");
			selectObj.find("h4").hide();
			selectObj.find(".barcode_wrap").css("background", "white");
			selectObj.find(".list_type3").hide();
			selectObj.find(".btn_wrap_ceType2").hide();
			selectObj.find(".dim_close").hide();
			selectObj.find(".mem_barcode_wrap").css('-webkit-print-color-adjust', 'exact');

			window.print();

			$("#wrap").show();
			$(document).attr("title", beforeTitle);
			selectObj.find('.layer_pop').css('top', beforeTop);
			selectObj.find(".dim_layer").css("background", "rgba(0,0,0,.7)");
			selectObj.find("h4").show();
			selectObj.find(".barcode_wrap").css("background", "#f7f7f7");
			selectObj.find(".list_type3").show();
			selectObj.find(".btn_wrap_ceType2").show();
			selectObj.find(".dim_close").show();
			selectObj.find(".mem_barcode_wrap").css('-webkit-print-color-adjust', '');
		}

		
		function MembershipCardDownload(cardType){

			if(cardType == 'Barcode'){
				html2canvas($(".barcodeDiv"), {
					onrendered : function(canvas){
						if(typeof FlashCanvax != "undefined"){
			...
			action_logging({_n_m02:"776699818.png"});
		}

		
		function showMemberInformation(){
			loadingOpen('entire');
			$("#form_goto").attr("action", "ViewMemberInfo.do");
			$("#form_goto").attr("target", "_self");
			$("#form_goto").submit();
		}
		
		
		function showMemberGrade(){
			loadingOpen('entire');
			$("#form_goto").attr("action", "GetMemberGradeInfo.do");
			$("#form_goto").attr("target", "_self");
			$("#form_goto").submit();
		}
		...
		function showCouponList(){
			action_logging({pagecode:"09_CPN_01"});
			loadingOpen('entire');
			$("#form_goto").attr("action", "ShowCouponList.do");
			$("#form_goto").attr("target", "_self");
			$("#form_goto").submit();
		}
		...
		function showFeedList(){
			action_logging({pagecode:"09_DASH_03"});
			loadingOpen('entire');
			$("#form_goto").attr("action", "ShowFeedList.do");
			$("#form_goto").attr("target", "_self");
			$("#form_goto").submit();
		}
		...
		function showFavorite(){
			action_logging({pagecode:"09_SET_01"});
			loadingOpen('entire');
			$("#form_goto").attr("action", "FavoriteRouteForm.do");
			$("#form_goto").attr("target", "_self");
			$("#form_goto").submit();
		}

		
		function showFavoriteRoute(){
			action_logging({pagecode:"09_FAV_01"});
			loadingOpen('entire');
			$("#form_goto").attr("action", "FavoriteRouteForm.do");
			$("#form_goto").attr("target", "_self");
			$("#form_goto").submit();
		...
		function showFamilyMember(type){
			if(type == "MILEAGE"){
				action_logging({pagecode:"09_DASH_06"});
			}else{
				action_logging({pagecode:"09_FMP_01"});
			}
			loadingOpen('entire');
			$("#form_goto").attr("action", "GetFMPPersonList.do");
			$("#form_goto").attr("target", "_self");
			$("#form_goto").attr("method","get");
			$("#form_goto").submit();
		}

		
		function showMileageSave(){
			loadingOpen('entire');
			$("#form_goto").attr("action", "GetMileageSaveRequestAsiana.do");
			$("#form_goto").attr("target", "_self");
			$("#form_goto").submit();
		}

		
		function showMileageList(type){
			if(type == "REST"){
				action_logging({pagecode:"09_DASH_04"});
			}else{
				action_logging({pagecode:"09_MILE_02"});
			}
			loadingOpen('entire');
			$("#form_goto").attr("action", "GetMileageDetail.do");
			$("#form_goto").attr("target", "_self");
			$("#form_goto").submit();
		}

		
		function showMileageUpgrade(){
			action_logging({pagecode:"09_MILE_01"});
			loadingOpen('entire');
			$("input[name=searchTab]").val("upgrade");
			$("#form_goto").attr("action", "GetMileageDetail.do");
			$("#form_goto").attr("target", "_self");
			$("#form_goto").submit();
		}
		...
		function showMileageExpire(){
			action_logging({pagecode:"09_DASH_05"});
			loadingOpen('entire');
			$("input[name=searchTab]").val("expire");
			$("#form_goto").attr("action", "GetMileageDetail.do");
			$("#form_goto").attr("target", "_self");
			$("#form_goto").submit();
		}
		...
		function showMemberNameChange(){
			action_logging({pagecode:"09_NAME_01"});
			loadingOpen('entire');
			$("#form_goto").attr("action", "ChangeMemberNamePage.do");
			$("#form_goto").attr("target", "_self");
			$("#form_goto").submit();
		}

		
		function showEventParticipation(){
			action_logging({pagecode:"09_EVT_01"});
			loadingOpen('entire');
			$("#form_goto").attr("action", "/C/KR/KO/mypage/event");
			$("#form_goto").attr("target", "_self");
			$("#form_goto").attr("method","get");
			$("#form_goto").submit();
		}
		...
		function showReservationList(){
			action_logging({pagecode:"09_BOOK_01"});
			loadingOpen('entire');
			$("#form_goto").attr("action", "RetrieveReservationList.do");
			$("#form_goto").attr("target", "_self");
			$("#form_goto").submit();
		}

		
		function showMemberInformationChange(){
			loadingOpen('entire');
			$("#form_goto").attr("action", "ModifyMemberInfoPage.do");
			$("#form_goto").attr("target", "_self");
			$("#form_goto").submit();
		}

		function sendAcnoBySMS(){
			var memberMobile = "82-010-4735-2699";

			if(memberMobile == ""){
				alert("저장된 휴대전화 번호가 존재하지 않습니다. 회원정보 변경 후 사용해주시기 바랍니다.");
				
			}else{
				memberMobile = memberMobile.replace(/-/gi, "");

				var name = "";
				var acno = "776"+" "+"699"+" "+"818";
				...
				$.ajax({
					...
					success : function(data) {
						alert("고객님의 회원정보 내 등록된 휴대전화로 회원번호를 발송하였습니다."); 
						$("#smsSend").find(".dim_close").trigger('click');
					},
					error : function(data){
		        ...
		        tooltips: {
		     	   callbacks: {
		     	        label: function(tooltipItem, data) {
		     	          return data['datasets'][0]['data'][tooltipItem['index']] +'마일'; 
		     	        }
		     	      },
		     	      backgroundColor: '#fff',
		     	      titleFontSize: 16,
		...
		if(totalMileage > 0){
			config.data = {
				datasets: [{
		            data: [etcMileage, exceptAsianaMileage, asianaMileage],
		            backgroundColor: [
		                'rgba(255, 195, 36, 1)',
		                'rgba(154, 131, 228, 1)',
		                'rgba(233, 51, 125, 1)'
...
<script type="text/javascript" >var _cf = _cf || []; _cf.push(['_setFsp', true]); _cf.push(['_setBm', true]); _cf.push(['_setAu', '/public/f67fc9d121576a410e665f8135125']);</script><script type="text/javascript"  src="/public/f67fc9d121576a410e665f8135125"></script></body>
</html>