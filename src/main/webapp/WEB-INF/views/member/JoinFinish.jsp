				...
				<ul>
					<li>
						...
						<div class="txt_wrap">
							<dl>
								<dt>마일리지 적립 및 사용</dt> 
								<dd>에브리에어클럽은 에브리에어의 사용우대 프로그램으로 '에브리에어클럽 마일리지'를 기반으로 운영됩니다. <br>에브리에어클럽 회원님께서는 아시아나 항공 및 제휴사를 이용하실 때마다 마일리지를 적립하실 수 있으며 적립된 마일리지로 마일리지 항공권 이용 <br>등이 가능하십니다.</dd> 
							</dl>				
						</div>
					</li>
					<li class="col2">
