...
<div id="container">
	...
	<!--- 검색 --->
	<form id="frm" action="./${board}List2">
	<div class="total_search_input">
		<div class="search_inner">
			...
			<input type="hidden" value="EveryAir클럽" name="menu">
	...
	<div class="tab_wrap">
		...
		<!--- tab-content --->
		<div id="tab-3" class="tab-content test current">
			<div class="bbs_list">
				<ul>
			<!-- 		<li class="bg_point">
						<div class="left">
			...
			<!--- paging --->
			<div class="paging">			
				<a href="./noticeList2?menu=EveryAir클럽&curPage=1" class="btn_first btn_common"></a>
			<c:if test = "${pager.curBlock>1}"> 
				<a href="./noticeList2?menu=EveryAir클럽&curPage=${pager.startNum-1}" class="btn_prev btn_common"></a>	
			 </c:if> 						
			<c:forEach begin="${pager.startNum}" end = "${pager.lastNum}" var="i">
				<a href="./noticeList2?menu=EveryAir클럽&curPage=${i}" class="pagingNo" id="page${i}">${i}</a>
			</c:forEach>		
			<c:if test = "${pager.curBlock<pager.totalBlock}">
				<a href="./noticeList2?menu=EveryAir클럽&curPage=${pager.lastNum+1}" class="btn_next btn_common"></a>			
			</c:if>		
			<fmt:parseNumber var="pages" integerOnly="true" value="${tc/10}"/>			
				<a href="./noticeList2?menu=EveryAir클럽&curPage=${pages+1}" class="btn_last btn_common"></a>
			</div>
		</div>		
	</div>
</div>
