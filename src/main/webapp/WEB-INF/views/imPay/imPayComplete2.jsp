...
<!-- 							<tr>
				...
				<div class="btn_area">
					<a href="../"><button type="button" id="btnNext" class="btn wine" style="line-height: 37px;">홈으로</button></a>
					<a href="../mypage/limo"><button type="button" id="btnNext" class="btn wine" style="line-height: 37px;">예매내역</button></a>
				</div>
	</div>
