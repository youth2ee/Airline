...
<html lang="KO"><head>
		...
		<meta name="keywords" content="체크인/좌석배정,Asiana Airlines,Asiana,Airlines,Fly,Flight,Ticket,Booking,Travel,Trip,Vacation,Business,Reservation,Checkin,Boarding Pass,Passenger">
		...
		<link rel="stylesheet" type="text/css" href="https://flyasiana.com//C/pc/css/corp.css">
	...
	<img src="https://eum.flyasiana.com/ne.nfl?category=ajax&amp;rr=https%3A%2F%2Fflyasiana.com%2Fpublic%2F40fecf9061576a410e665f8135125&amp;referrer=https%3A%2F%2Fflyasiana.com%2FC%2FKR%2FKO%2Fcontents%2Fonline-check-in&amp;lang=ko&amp;c=&amp;ss=&amp;os=windows&amp;osg=windows&amp;osv=10&amp;arch=64&amp;wb=chrome&amp;wbv=79.0.3945.117&amp;wbg=chrome&amp;le=blink&amp;leg=blink&amp;dd=unknown&amp;ddg=pc&amp;browsing_type=B&amp;t=nprd&amp;v=1.2.7&amp;cv=0.2&amp;uuid=156703162541615400&amp;pr=0&amp;pa=0&amp;pl=0&amp;pc=0&amp;ps=42&amp;pv=1&amp;pd=0&amp;po=0&amp;pt=43&amp;user_end_time=1579747975&amp;error=201&amp;url=https%3A%2F%2Fflyasiana.com%2Fpublic%2F40fecf9061576a410e665f8135125&amp;method=POST&amp;1579747975530" width="1" height="1" style="left: 0px; position: absolute; display: none;"><img src="https://eum.flyasiana.com/ne.nfl?category=ajax&amp;rr=https%3A%2F%2Fflyasiana.com%2Fpublic%2F40fecf9061576a410e665f8135125&amp;referrer=https%3A%2F%2Fflyasiana.com%2FC%2FKR%2FKO%2Fcontents%2Fonline-check-in&amp;lang=ko&amp;c=&amp;ss=&amp;os=windows&amp;osg=windows&amp;osv=10&amp;arch=64&amp;wb=chrome&amp;wbv=79.0.3945.117&amp;wbg=chrome&amp;le=blink&amp;leg=blink&amp;dd=unknown&amp;ddg=pc&amp;browsing_type=B&amp;t=nprd&amp;v=1.2.7&amp;cv=0.2&amp;uuid=112202904875613070&amp;pr=0&amp;pa=0&amp;pl=0&amp;pc=0&amp;ps=28&amp;pv=0&amp;pd=0&amp;po=0&amp;pt=28&amp;user_end_time=1579747975&amp;error=201&amp;url=https%3A%2F%2Fflyasiana.com%2Fpublic%2F40fecf9061576a410e665f8135125&amp;method=POST&amp;1579747975625" width="1" height="1" style="left: 0px; position: absolute; display: none;"><img src="https://eum.flyasiana.com/ne.nfl?category=browser&amp;pr=49&amp;pa=0&amp;pl=0&amp;pc=0&amp;ps=276&amp;pv=11&amp;pd=1156&amp;po=2&amp;pt=1494&amp;rr=https%3A%2F%2Fflyasiana.com%2FI%2FKR%2FKO%2FCheckIn.do&amp;referrer=https%3A%2F%2Fflyasiana.com%2FC%2FKR%2FKO%2Fcontents%2Fonline-check-in&amp;lang=ko&amp;c=&amp;ss=&amp;os=windows&amp;osg=windows&amp;osv=10&amp;arch=64&amp;wb=chrome&amp;wbv=79.0.3945.117&amp;wbg=chrome&amp;le=blink&amp;leg=blink&amp;dd=unknown&amp;ddg=pc&amp;browsing_type=B&amp;t=nprd&amp;v=1.2.7&amp;cv=0.2&amp;txid=&amp;user_end_time=1579747976&amp;1579747976356" width="1" height="1" style="left: 0px; position: absolute; display: none;"></head>
	<body>

		<form name="checkInFrm" id="checkInFrm" method="post">
			<input type="hidden" name="ln" id="ln" value="ko">
			<input type="hidden" name="IDepartureDate" id="IDepartureDate" value="">
			<input type="hidden" name="IIdentificationBookingRef" id="IIdentificationBookingRef" value="">
			<input type="hidden" name="channel" id="channel" value="">
		</form>
		<form name="preSeatAutoChkFrm" id="preSeatAutoChkFrm" method="post">
			<input type="hidden" name="callPage" id="callPage" value="CHECKIN">
			<input type="hidden" name="lastName" id="lastName" value="">
			<input type="hidden" name="bizType" id="bizType" value="">
			<input type="hidden" name="officeId" id="officeId" value="">
			<input type="hidden" name="pnrAlpha" id="pnrAlpha" value="">
			<input type="hidden" name="departureDate" id="departureDate" value="">
			<input type="hidden" name="sessionUniqueKey" id="sessionUniqueKey" value="">
			<input type="hidden" name="isPnrDetailNoCurr" id="isPnrDetailNoCurr" value="">
			<input type="hidden" name="isPnrDetailNotOZStock" id="isPnrDetailNotOZStock" value="">
		</form>
...
<script type="text/javascript" async="" src="https://www.gstatic.com/recaptcha/releases/A1Aard-wURuGsXRGA7JMOqVO/recaptcha__ko.js"></script><script async="" src="https://ozimg.flyasiana.com/js/appinsightor.min.js"></script><script type="text/javascript" src="/C/pc/js/script_observer.js"></script>
	...
	<div class="inner">
		...
		<div class="util_menu">
			<ul>
				...
				<li>
					<a href="javascript:sharpNothig();" onclick="action_logging_common('TOSP_05'); cms.goToLink('/C/KR/KO/event/index?menuId=CM201802220000728482');">이벤트</a>
				</li>
				<li>
		...
		<div class="box_share_pop toggle_event_wrap" id="snsArea" style="display:none;">
			...
			<div class="box_share_sns">
				<ul>
							...
							<li><a href="javascript:sharpNothig();" class="btn_facebook42" title="Facebook 공유하기 - 새창">Facebook</a></li>
							<li><a href="javascript:sharpNothig();" class="btn_twitter42" title="Twitter 공유하기 - 새창">Twitter</a></li>
							<li><a href="javascript:sharpNothig();" class="btn_kakaostory42" title="KakaoTalk 공유하기 - 새창">KakaoTalk</a></li>
			...
			<div class="container" id="container">
				...
				<div class="search_box mar_to10">
					<div class="inner alC">
						...
						<input type="text" id="input_reservNo" maxlength="8" placeholder="영문/숫자 조합 6자리 또는 숫자 8자리" title="번호 입력 예시 : 영문/숫자 조합 6자리 또는 숫자 8자리" style="width:280px; text-transform: uppercase;">
						<input type="text" id="input_ticketNo" maxlength="13" placeholder="숫자 13자리" style="width:280px; display:none;">	


						<div class="relative_calendar">
							<div class="calendar_wrap">
								<input type="text" id="departureDate1" class="datepicker input_cal" placeholder="탑승일 선택" title="탑승일" data-dateformat="y.mm.dd D" style="width:158px;" data-type="single_checkin">
								
								<a href="javascript:sharpNothig();" class="btn_airport type2 calendar_focus" id="calendar_focus1"><span class="hidden">탑승일 선택 달력보기</span></a>
							</div>
							...
							<div class="calendar_layer">
								...
								<a href="javascript:sharpNothig();" class="cal_status02">탑승일</a>
								<a href="javascript:sharpNothig();" class="cal_reset"><span class="hidden">달력 새로고침</span></a>
				...
				<div id="div_captcha" style="display: none;">
							...
							<div id="g-recaptcha" class="g-recaptcha" style="display: inline-block;"><div style="width: 304px; height: 78px;"><div><iframe src="https://www.google.com/recaptcha/api2/anchor?ar=1&amp;k=6LcyoDwUAAAAAG42mLWkJPNAs35QRLvnl2O0xOCJ&amp;co=aHR0cHM6Ly9mbHlhc2lhbmEuY29tOjQ0Mw..&amp;hl=ko&amp;v=A1Aard-wURuGsXRGA7JMOqVO&amp;size=normal&amp;cb=vf1g44civ4lq" width="304" height="78" role="presentation" name="a-sqpi35n32am6" frameborder="0" scrolling="no" sandbox="allow-forms allow-popups allow-same-origin allow-scripts allow-top-navigation allow-modals allow-popups-to-escape-sandbox"></iframe></div><textarea id="g-recaptcha-response" name="g-recaptcha-response" class="g-recaptcha-response" style="width: 250px; height: 40px; border: 1px solid rgb(193, 193, 193); margin: 10px 25px; padding: 0px; resize: none; display: none;"></textarea></div></div>
						
				</div>
				
					<p class="col_brown">* 회원 로그인 후 예약을 조회할 수 있습니다.<a href="javascript:sharpNothig();" id="btnMoveLogin" class="btn_arrow">로그인</a></p>
					<div class="title_wrap_type3">
						<h4>체크인 안내</h4>
					</div>
							...
							<dd class="full">
								<div class="icon_wrap type03 col3">
									<dl>
										...
										<dd><button type="button" class="btn_XS white" id="btn_movePage_onlineCheckIn">자세히보기</button></dd>
									</dl>
									<dl>
										<dt>
										...
										<dd class="desc">언제든지 신청만 해놓으면<br>출발 24시간 전에 자동으로!</dd>
										<dd><button type="button" class="btn_XS white" id="btn_movePage_autoCheckIn">자세히보기</button></dd>
									</dl>
									<dl>
										<dt>
										...
										<dd class="desc">사전 체크인을 못했더라도,<br>공항에서도 빠르고 편리하게!</dd>
										<dd><button type="button" class="btn_XS white" id="btn_movePage_keyOsk">자세히보기</button></dd>
									</dl>
								</div>
							</dd>
						</dl>
					...
					<table class="table_list" id="tb_checkInTimeNotice">
						...
						<p>서비스 구분,국제선,국내선,온라인 체크인,좌석배정/오토체크인 로 구성된 표입니다.</p></caption>
						<colgroup>
					...
					<p class="col_brown mar_to10">* * 단, 미주 노선의 온라인 체크인은 출발 24시간 전부터 가능합니다.</p>
					...
					<ul class="list_type2">
						...
						<li><span class="col_black">이용 제한 대상</span>
							<ul>
								...
								<li>좌석배정 : 10인 이상 단체예약, 24개월 미만 소아 동반시 48시간 이전 좌석배정이 제한됩니다.  (체크인은 가능)</li>
							</ul>
						</li>
						<li>타사 항공기로 운항하는 공동운항편을 이용하실 경우 체크인 및 좌석배정 이용이 제한됩니다. (운항 항공사로 문의)</li>
						<li>이미 좌석배정 및 체크인을 마치신 경우에도 입력 정보 확인 및 변경이 가능합니다.</li>
						<li>온라인 체크인에 대해 더 궁금한 점이 있으신가요?<a id="btnOnlineCheckInfo" href="javascript:sharpNothig();" class="btn_arrow">온라인 체크인 안내</a></li>
						
					</ul>
				</div>

				
				<div id="div_checkInPossible" class="layer_wrap">
					<div class="dim_layer"></div>
					<div class="layer_pop" style="width: 800px; top: 403px;">
						<div class="pop_cont">
							<h4>여정 선택</h4>
							<ul class="list_type3">
								<li>좌석배정/체크인을 원하는 항공편을 선택해주세요.</li>
							</ul>
							<dl id="div_checkInFlight" class="toggle_box">
							</dl>
				...
				<div id="div_checkInImpossible" class="layer_wrap">
					<div class="dim_layer"></div>
					<div class="layer_pop" style="width: 500px; top: 403px;">
						<div class="pop_cont">
							<p class="pop_tit st1">체크인 가능 기간이 아닙니다.</p>
							<p class="pop_tit st3">
								국제선 온라인 체크인 가능 시간 : 출발일 기준 48시간 ~ 1시간 전<br>국내선 온라인 체크인 가능 시간 : 출발일 기준 24시간 ~ 30분
							</p>
							
							<p class="pop_tit st3" id="id_InfAndGroupCase" style="display:none">
								본 예약은 온라인 예약조회나 좌석배정이 불가합니다.<br>
								<span class="col_red">출발 48시간 전부터 온라인 체크인을 통해 좌석 선택이 가능합니다.</span>
								예약내역에 대한 상세한 내용은 구매처를 통해 확인해주시기 바랍니다.
							</p>
							
							<p class="pop_tit st3" id="idOnlySeatMapCase" style="display:none">
								<span class="col_red">현재는 좌석배정 및 오토체크인이 가능합니다.</span><br>
								‘좌석배정 바로가기’ 버튼을 누르면 좌석배정으로 이동합니다.
							</p>
							
						</div>
						<div class="btn_wrap_ceType2">
							<button type="button" class="btn_M red" id="btnGoSeatMap">좌석배정 바로가기</button>
							<button type="button" class="btn_M white" id="btnOnlineCheckInfoConfirm">닫기</button>
							<!-- <button type="button" id="btnOnlineCheckInfoConfirm" class="btn_M red">확인</button> -->
						</div>
						<a href="javascript:sharpNothig();" class="dim_close"><span class="hidden">닫기</span></a>
					</div>
				</div>
				...
				<div class="layer_wrap" id="div_existSeatOrACI" style="display: none;">
					<div class="dim_layer"></div>
					<div class="layer_pop" style="width: 800px; top: 403px;">
						<div class="pop_cont">
							<h4>좌석배정/오토체크인 신청 내역</h4>
							<!-- scroll_cont2 -->
							<div class="scroll_cont2" tabindex="0">
								<ul class="list_type3">
									<li class="col_red">항공기 출발전 기종변경 등으로 예고 없이 지정하신 좌석이 변경될 수 있음을 안내 드립니다.</li>
									<li>신청하신 좌석배정/오토체크인 내역을 확인하세요.</li>
									<li>유료석을 신청하신 경우 변경이 불가하오니, 환불 후 재구매 하시기 바랍니다. (출발 48시간 이전 : 환불 수수료 무료 / 출발 48시간 이내 : 환불 불가)</li>
								</ul>
								<dl class="toggle_box" id="dl_existSeatOrACI_toggle_1">
									<dt>
										<div class="fl location">
											<input type="checkbox" id="check1">
											<label for="check1" id="lb_check1">
												<span id="span_flightDepAirport"></span>
												<span id="span_flightArrAirport"></span>
											</label>
										</div>
										<div class="fr">
											<span class="date" id="span_flightDate"></span>
											<span class="divsion_line type3"></span>
											<span id="span_flightInfo1"></span>
											<button type="button" class="btn_arrow_toggle on">
									...
									<!-- 신청내역상세 -->
									<dd class="on">
										<table class="table_list" id="tb_existSeatOrACI1">
											<caption>
												<strong>좌석배정/오토체크인 신청내역 표</strong>
												<p></p>
											</caption>
											<colgroup>
						...
						<div class="btn_wrap_leriType3">
							<div class="right">
								<button type="button" class="btn_M white" id="btn_preferredSeats">좌석배정/변경</button>
								<button type="button" class="btn_M red" id="btn_autoCheckIn">오토체크인 신청/변경</button>
							</div>
						</div>
						<a href="javascript:sharpNothig();" class="dim_close"><span class="hidden">닫기</span></a>
					</div>
	...
	<div class="inner">
		...
		<div class="group_wrap">
			<div class="group_site">
				<a href="javascript:sharpNothig();" class="famliy_site">
					<span>그룹사 바로가기</span>
				</a>
				<ul class="site_list">
...
<dl>
	<dt><a href="javascript:sharpNothig();">회사소개</a></dt>
	<dd>
				...
				<ul>
					<li><a href="javascript:sharpNothig();" onclick="action_logging_common('FOOTER_01'); cms.goToLink('/C/KR/KO/company/joint-flight/staraliance');">제휴 항공사</a></li>
					<li><a href="javascript:sharpNothig();" onclick="action_logging_common('FOOTER_01'); cms.goToLink('/C/KR/KO/cms/contents/menu/CM201802220000728506');">사회공헌</a></li>
					<li><a href="javascript:sharpNothig();" onclick="action_logging_common('FOOTER_01'); cms.goToLink('/C/KR/KO/contents/performance-results');">IR</a></li>
				</ul>
			
	</dd>
</dl>
<dl>
	<dt><a href="javascript:sharpNothig();">약관 및 규정</a></dt>
	<dd>
		<ul>
			
				<li class="privacy_policy">
					<a href="/C/pc/ag/common/pdf/ISMS_certification_kor.pdf" target="_blank" title="정보보호관리체계인증마크 ISMS 13-064 (새창)" class="ico">
						<span class="hidden">정보보호관리체계인증마크 ISMS 13-064 (새창)</span>
					</a>
			
				<a href="javascript:sharpNothig();" onclick="action_logging_common('FOOTER_02'); cms.goToLink('/C/KR/KO/company/terms/personal/homepage');">개인정보처리방침</a>
			</li>
			<li><a href="javascript:sharpNothig();" onclick="action_logging_common('FOOTER_02'); cms.goToLink('/C/KR/KO/cms/contents/menu/CM201802220000728522');">운송 약관 및 고지사항</a></li>
...
<dl>
	<dt><a href="javascript:sharpNothig();">기타안내</a></dt>
	<dd>
		
			<ul>
				<li><a href="javascript:sharpNothig();" onclick="action_logging_common('FOOTER_03'); cms.goToLink('/C/KR/KO/cms/contents/menu/CM201802220000728527');">항공교통이용자 서비스계획</a></li>
				<li><a href="javascript:sharpNothig();" onclick="action_logging_common('FOOTER_03'); cms.goToLink('/C/KR/KO/cms/contents/menu/CM201802220000728523');">소비자 안전정보 안내</a></li>
				<li><a href="javascript:sharpNothig();" onclick="action_logging_common('FOOTER_03'); cms.goToLink('/C/KR/KO/etc/sitemap');">사이트 맵</a></li>
			</ul>
			<ul>
				...
				<li><a href="javascript:sharpNothig();" onclick="action_logging_common('FOOTER_03'); location.href='/C/KR/KO/common/file/download-static-file/damage-redress/pdf/Application_for_Damage_Redress';">피해 구제 계획</a></li>
				<li><a href="javascript:sharpNothig();" onclick="action_logging_common('FOOTER_03'); cms.goToLink('/C/KR/KO/cms/contents/menu/CM201802220000728387');">유료 부가서비스</a></li>
				<li><a href="javascript:sharpNothig();" onclick="action_logging_common('FOOTER_03'); cms.goToLink('/C/KR/KO/cms/contents/menu/CM201802220000728517');">광고 안내</a></li>
			</ul>
	...
	<div class="special_logo">
		...
		<!-- //address -->
			...
			<form name="moveLoginForm" id="moveLoginForm" method="post">
				<input type="hidden" id="callType" name="callType">
				<input type="hidden" id="movePage" name="movePage">
			</form>
...
<div id="_dummy-coupon" style="display: none;"></div>
...
<script type="text/javascript">
	...
	* */
	...
	function commonLinkConvert(_val,_self){
		...
		<script type="text/javascript" src="/C/pc/js/jquery-ui.min.js"></script>
		<script type="text/javascript" src="/C/pc/js/moment.min.js"></script>
		<script type="text/javascript" src="/C/pc/js/dateUtil.js"></script>
		<script type="text/javascript" src="/C/pc/js/set_calendar.js"></script>
		<script type="text/javascript" src="/C/pc/js/jquery.glob.js"></script>
		<script type="text/javascript" src="/resources/script/jquery.form-3.46.js"></script>
		<script type="text/javascript" src="/resources/script/jquery-ui-custom.js"></script>
		...
		<script type="text/javascript" src="/js/common/weblog.js"></script>
			...
			<script type="text/javascript" src="https://www.google.com/recaptcha/api.js?onload=onloadCallback&amp;render=explicit&amp;hl=KO" async="" defer=""></script>
			
			<script type="text/javascript">
				function onloadCallback() {
					grecaptcha.render('g-recaptcha', {
						 sitekey : '6LcyoDwUAAAAAG42mLWkJPNAs35QRLvnl2O0xOCJ'
					});
				}
			</script>
		...
		<script type="text/javascript">
			...
			var userDataJSON		= '';
			var reservNoRegex		= /[^A-Z0-9]/;
			var numberRegex			= /[^0-9]/;
			var lastName			= userDataJSON.lastName;
			var languageCode		= 'KO';
			var mainChkInCallPage	= '';
			var mainChkInSession    = '';
			...
			$(document).ready(function() {
				...
				keyupOnlyNum($("#input_ticketNo"));

				if(mainChkInCallPage !=  "" && mainChkInSession != ""){
					$('#div_captcha').show();
				}

				
				tableCaption('.breakdown_table');
				tableCaption('#tb_checkInTimeNotice');


				$('#lastName').val(lastName);

				
				$(document).on('click', 'a[id^=flight_name_]', function(){
					viewFlightDetail($(this), '', '', '');
				});
				...
				$(document).on('click', '#a_existSeatOrACILayerTooltip', function(){
					$('div[id=div_existSeatOrACILayerTooltip]').each(function(){
						$(this).hide();
					})
					$(this).next('div').show();
				});
				...
				$(document).on("click","#btn_autoCheckIn", function(){
					...
					setPreferredSeatsOrAutoCheckIn(bizType, officeId, pnrAlpha, pnrNumeric, lastName, "AutoCheckIn");
				});
				$(document).on("click","#btn_preferredSeats", function(){
					var bizType    = $(this).attr('bizType');
					var officeId   = $(this).attr('officeId');
					var pnrAlpha   = $(this).attr('pnrAlpha');
					var pnrNumeric = $(this).attr('pnrNumeric');
					var lastName   = $(this).attr('lastName');
					setPreferredSeatsOrAutoCheckIn(bizType, officeId, pnrAlpha, pnrNumeric, lastName, "PreferredSeat");
				});


				
				$("button[id^=btn_movePage]").on("click", function(event) {
					event.stopPropagation();

					var thisId = $(this).attr('id').replace('btn_movePage_' , '');
					var linkUrl = "/C/" + countryCode + "/" + languageCode + "/cms/contents/menu/CM201802220000728287?menuId=CM201802220000728287";
					if(thisId === 'autoCheckIn'){
						linkUrl = "/C/" + countryCode + "/" + languageCode + "/cms/contents/menu/CM201802220000728288?menuId=CM201802220000728288";
					}else if(thisId === 'keyOsk'){
						linkUrl = "/C/" + countryCode + "/" + languageCode + "/cms/contents/menu/CM201802220000728290?menuId=CM201802220000728290";
					}

					$('<form action="' + linkUrl + '" method="post" target="_blank" rel="noopener noreferrer"></form>').appendTo('body').submit().remove();
					return;
				});


				
				$("#input_reservNo").off("keyup").on("keyup", function(event) {
					event.stopPropagation();
				...
				$(document).off("change", "#numTypeSelect").on("change", "#numTypeSelect", function(event) {
					event.stopPropagation();

					var jsThis		= this;
					var jsThisValue	= jsThis.value;

					$("#input_reservNo, #input_ticketNo").hide();
					if(jsThisValue == "reservNo") {
						$("#input_reservNo").show();
					}
					if(jsThisValue == "ticketNo") {
						$("#input_ticketNo").show();
					}
				});
				...
				$('#btnMoveLogin').on('click', function() {
					var $moveLoginForm_id	= $("#moveLoginForm");

					$moveLoginForm_id.find("#callType").val('IBE');
					$moveLoginForm_id.find("#movePage").val('CheckIn.do');

					
					$moveLoginForm_id.attr({
						'onsubmit'	: 'return true',
						'action'	: 'viewLogin.do'
					}).submit();
				});
				
				$('#btnOnlineCheckInfo').off("click").on('click', function(event) {
					//event.stopPropagation();
					var jsThisId	= this.id;
					var linkUrl = "/C/" + countryCode + "/" + languageCode + "/cms/contents/menu/CM201802220000728287?menuId=CM201802220000728287";
					$('<form action="' + linkUrl + '" method="post" target="_blank" rel="noopener noreferrer"></form>').appendTo('body').submit().remove();
					return;
				});
				...
				$('#btnOnlineCheckInfoConfirm').off("click").on('click', function(event) {
					//event.stopPropagation();
					
					$("#div_checkInImpossible").find(".dim_close").click();
					$("#btnGoSeatMap").show();
				});
				...
				$(document).on('click', '#btn_search', function() {
					...
					var searchType	= '';
					var jsNumType	= $("#numTypeSelect").val();
					if(jsNumType == "reservNo") {
						searchType = 'pnrNo';
					}
					if(jsNumType == "ticketNo") {
						searchType = 'ticketNo';
					}
					...
					var moment_depDate	= moment($("#departureDate1").val(), "YY.MM.DD (d)").format("YYYYMMDD");
					searchDetailInInput(moment_depDate, $("#input_reservNo").val().toUpperCase(), searchType, jsThis.id);
				});



				
				$(document).off('click', 'button[id^=btn_reservList_search_]').on('click', 'button[id^=btn_reservList_search_]', function(event) {
					event.stopPropagation();

					var $this	= $(this);
					var depDate = $this.attr('depDate').substring(0,8);
					var pnrNo   = $this.attr('pnrNo');
					var uniqueNo= $this.attr('uniqueNo');

					var jsThis	= this;

					searchDetailInReservList(depDate, pnrNo, userDataJSON.lastName, uniqueNo, 'pnrNo', jsThis.id);
				});



				
				$(document).on('click', '#btn_imposLayerConfirm', function(){
					$("#div_checkInImpossible").hide();
					$('body').css('overflow-y' , 'auto');
				});
				$(document).on('click', '#btn_posLayerConfirm', function(){
					$("#div_checkInPossible").hide();
					$('body').css('overflow-y' , 'auto');
				});
				$(document).on('click', '#btn_emptyReservLayer', function(){
					$("#div_emptyReserv").hide();
					$('body').css('overflow-y' , 'auto');
				});
				...
				$(document).on("click","button[name=btn_checkIn]", function() {
					...
					var checkId	= $('#' + thisId.replace('btn', 'chk')).attr('id');
					...
					if(isCheckIn === 'Y') {
						...
						var operationcarriercode = $this.attr('operationcarriercode');
						var departureCity        = $this.attr('departureCity');
						var arrivalCity          = $this.attr('arrivalCity');
						var pnrAlpha             = $this.attr('pnrAlpha');
						var useCheckInBlock      = $this.attr('useCheckInBlock');
						setCheckIn(departureDate, pnrAlpha);
					} else {
						var hasInfant = $this.attr('hasInfant');
						var groupPnr = $this.attr('groupPnr');
						if(hasInfant === "Y") {
							showBlockLayer("HAS_INFANT", thisId);
							
							return;
						} else if(groupPnr === "Y") {
							showBlockLayer("GROUP_PNR", thisId);
						} else {
							var lastName = $this.attr('lastName');
							var officeId = $this.attr('officeId');
							var bizType  = $this.attr('bizType');
							var pnrAlpha = $this.attr('pnrAlpha');
							var existSeatOrACI = $this.attr('existSeatOrACI');
							if(existSeatOrACI === 'true'){
			...
			function searchValid() {
				var $numTypeSelect_id	= $("#numTypeSelect");
				var $input_reservNo_id	= $("#input_reservNo");
				var $input_ticketNo_id	= $("#input_ticketNo");
				if($numTypeSelect_id.val() === 'reservNo') {
					if($input_reservNo_id.val() === '') {
						$input_reservNo_id.focus();
						alert("예약번호를 입력해 주시기 바랍니다.");
						return false;
					}
			    	if(reservNoRegex.test($("#input_reservNo").val().toUpperCase())) {
			    		alert("예약번호값 형식을 확인해 주시기 바랍니다.");
			    		$input_reservNo_id.focus();
		    			return false;
			    	}
			    	if(numberRegex.test($input_reservNo_id.val().toUpperCase())) {
			    		if($input_reservNo_id.val().length !== 6) {
			    			alert("예약번호값 형식을 확인해 주시기 바랍니다.");
				    		$input_reservNo_id.focus();
			    			return false;
			    		}
			    	} else {
			    		if($input_reservNo_id.val().length !== 8) {
				    		alert("예약번호값 형식을 확인해 주시기 바랍니다.");
				    		$input_reservNo_id.focus();
			    			return false;
			    		}
					...
					if($input_ticketNo_id.val() === '') {
						$input_ticketNo_id.focus();
						alert("항공권번호를 입력해 주시기 바랍니다.");
						return false;
					}
					if(numberRegex.test($input_ticketNo_id.val())) {
						alert("항공권번호값 형식을 확인해 주시기 바랍니다.");
			    		$input_ticketNo_id.focus();
		    			return false;
			    	}
			    	if($input_ticketNo_id.val().length !== 13) {
				    	alert("항공권번호값 형식을 확인해 주시기 바랍니다.");
				    	$input_ticketNo_id.focus();
			    		return false;
			    	}
				...
				if($('#departureDate1').val() === undefined || $('#botDetectCaptchaCodedepartureDate1').val() === '') {
					$('#departureDate1').focus();
					alert("탑승일을 선택하세요.");
					return false;
				}


				if($('#div_captcha').css('display') !== "none"){
					if('KR' == 'CN'){
						if($('#botDetectCaptchaCode').val() == null || $('#botDetectCaptchaCode').val() == ''){
							alert("입력 오류 횟수가 초과되었습니다.\n스팸방지 코드를 확인하시기 바랍니다.");
							return false;
						}
					}else{
			...
			var searchDetailInInput = function searchDetailInInput(s_departureDate, pnrNo, searchType, clickId) {
				
				var param = {
						callPage		 : "CHECKIN",
						sessionUniqueKey : "619da234-f40a-4249-8a70-390a54b07369",
						mainChkInCallPage: mainChkInCallPage,
						mainChkInSession : mainChkInSession,
						departureDate	 : s_departureDate,
						pnrNo			 : pnrNo,
						searchType		 : searchType,
						ticketNo		 : $("#input_ticketNo").val(),
						isReservList	 : false
				};
				
				if($('#div_captcha').css('display') !== "none"){
					if('KR' == 'CN'){
						param.captchaCode = $('#botDetectCaptchaCode').val();
						param.captchaId = 'botDetectCaptcha';

						var backWorkaround = 'BDC_BackWorkaround_' + param.captchaId;
						var vcid = 'BDC_VCID_' + param.captchaId;

						param[backWorkaround] = $('#' + backWorkaround).val();
						param[vcid] = $('#' + vcid).val();
					}else{
						param.captchaCode = grecaptcha.getResponse();
					}
				}

				$.ajax({
					url			: 'CheckInReservationDetailSearch.do',
					type		: 'POST',
					dataType	: 'json',
					data		: param,
					beforeSend  : function () {
					...
					success		: function(data) {
						...
						var weblogData = 'reservation';
						if(searchType !== 'pnrNo'){
							weblogData = 'ticket';
						}
						action_logging({_n_m10:weblogData})
						...
						if(data.verificationFailCnt >= 5 || (data.verificationFailCnt > 0 && mainChkInCallPage != '' && mainChkInSession != '')){
							$('#div_captcha').show();

							if('KR' == 'CN'){
								$("#div_captcha").find("[id=botDetectCaptchaCode]").get(0).Captcha.ReloadImage();
								$('#botDetectCaptchaCode').val('');
							}else{
								grecaptcha.reset();		
							}
						}else{
						...
						if(data.verification) {
							$('#hidJsessionId').val(data.pnrData.jsessionId);

							var segDatas		= data.pnrData.segmentDatas;
							var pnrAlpha		= data.pnrData.pnrAlpha;
							var pnrNumeric		= data.pnrData.pnrNumeric;
							var bizType			= data.pnrData.bizType;
							var officeId		= data.pnrData.officeId;
							var domIntType		= data.pnrData.domIntType;
							var lastName        = data.pnrData.reservationLastName;
							...
							var codeshare            = '';
							var operationcarriercode = '';
							var departureCity        = '';
							var arrivalCity          = '';

							for(var i = 0, n = segDatas.length ; i < n  ; i++) {
								if(roofStop) {
									break;
								}

								for(var j = 0, z = segDatas[i].flightInfoDatas.length ; j < z ; j++) {
									...
									if(flightInfoDatas.carrierCode === 'OZ' && (flightInfoDatas.operationCarrierCode === '' || flightInfoDatas.operationCarrierCode === 'OZ')) {
										...
										if(s_departureDate === flightInfoDatas.departureDate.substring(0, 8)) {
											departureDate        = flightInfoDatas.departureDate;
											departureAirport     = flightInfoDatas.departureAirport;
											codeshare            = flightInfoDatas.codeShare;
											operationcarriercode = flightInfoDatas.operationCarrierCode;
											departureCity        = flightInfoDatas.departureCity;
											arrivalCity          = flightInfoDatas.arrivalCity;

											if("C" === flightInfoDatas.checkInType) {	
												checkInPossible = true;
												preSeatPossible = false;
												roofStop = true;
												break;
											} else if("S" === flightInfoDatas.checkInType) {	
 							...
 							var existSeatOrACI = false;
							for(var i = 0; i < data.pnrData.passengerDatas.length; i++){
								
								if(data.pnrData.passengerDatas[i].seatData != null){
									existSeatOrACI = true;
									break;
								}
								
								if(data.pnrData.passengerDatas[i].existACI){
									existSeatOrACI = true;
									break;
								}
							}
							...
							if(checkInPossible) {
							...
							} else if(preSeatPossible) {
								
								if(data.infPassenger) {
									showBlockLayer("HAS_INFANT", clickId);
								...
								if(data.groupPnr) {
									showBlockLayer("GROUP_PNR", clickId);
									
									return;
								}
								
								if(existSeatOrACI){
									setExistSeatOrACILayer(data.pnrData, existSeatOrACI);
									openLayerPopup('div_existSeatOrACI', clickId);
								}else{
									
									showBlockLayer("ONLY_SEAT",clickId,  function(){
										if(bizType === '') {
											bizType = 'REV';
										}
										$('#bizType').val('').val(bizType);
										$('#departureDate').val('').val(departureDate);
										$('#pnrAlpha').val('').val(pnrAlpha);
										$('#officeId').val('').val(officeId);
										setPreferredSeatsOrAutoCheckIn(bizType, officeId, pnrAlpha, pnrNumeric, lastName, "PreferredSeat");
									});
								}
								...
								$("#div_onlineReservImpossible").hide();
								$("#btnGoSeatMap").hide();
			 					openLayerPopup("div_checkInImpossible", clickId);
							}
...
// 			var setCheckInLayerPopup = function setCheckInLayerPopup(segDatas, pnrAlpha, domIntType, lastName, hasInfant) {
			var setCheckInLayerPopup = function setCheckInLayerPopup(pnrData, infPassenger, groupPnr, existSeatOrACI) {

				var layerHtml = '';
				var preSeatCnt = 0;
				var isAutoCheckIn = false;
				var isCheckInOrSeat = false;
				var isCheckIn = false;
				var targetCnt = 0;
				var allFltCnt = 0;
				...
				var domIntType = pnrData.domIntType;
				...
				setExistSeatOrACILayer(pnrData, existSeatOrACI);
				...
				for(var i = 0 ; i < segDatas.length ; i++) {
					for(var j = 0 ; j < segDatas[i].flightInfoDatas.length ; j++) {
						...
						if(flightInfo.carrierCode === 'OZ' && (flightInfo.operationCarrierCode === '' || flightInfo.operationCarrierCode === 'OZ')) {
							allFltCnt++;

							isAutoCheckIn = false;
							isCheckInOrSeat = false;
							isCheckIn = false;
							var checkInTm = 48;
							var seatChkTm = 30;
							var btnText = '';
							...
							if("C" === flightInfo.checkInType) {
								var useCheckInBlock = '';
								isCheckInOrSeat = true;
								isAutoCheckIn = false;
								isCheckIn = true;
								allSegPreSeatCheck = "C";
								btnText = "체크인";
								btnAttr = 'isCheckIn="Y" codeShare="' + flightInfo.codeShare + '" departureAirport="' + flightInfo.departureAirport +'" departureDate="'
										+ flightInfo.departureDate + '" operationCarrierCode="' + flightInfo.operationCarrierCode + '" departureCity="'
										+ flightInfo.departureCity + '" arrivalCity="' + flightInfo.arrivalCity + '" pnrAlpha="' + pnrAlpha + '" ';
								btnAttr += 'useCheckInBlock="'+useCheckInBlock+'" ';

							} else if("S" === flightInfo.checkInType) {
								isCheckInOrSeat = true;
								isAutoCheckIn = true;
								isCheckIn = false;
								isAllSegPreSeat = true;
								btnText = "좌석배정/오토체크인";
								btnAttr = 'isCheckIn="N" ';
								preSeatCnt++;

								// 탑승객에 유아가 존재하는 경우 선호좌석 불가.
								if(groupPnr) {
									isAutoCheckIn = false;
									btnAttr += 'groupPnr="Y" ';
								} else if(infPassenger){
									isAutoCheckIn = false;
									btnAttr += 'hasInfant="Y" ';
								}else {
									btnAttr += 'bizType="'+$('#bizType').val()+'" ';
									btnAttr += 'pnrAlpha="'+pnrAlpha+'" ';
									btnAttr += 'officeId="'+$('#officeId').val()+'" ';
									btnAttr += 'lastName="'+lastName+'" ';
									btnAttr += 'existSeatOrACI="'+existSeatOrACI+'" ';
								}
							} else {
								isCheckInOrSeat = false;
								isAutoCheckIn = false;
								isCheckIn = false;
								isAllSegPreSeat = false;
								btnText = '';
								btnAttr = '';
							}
							...
							var depDate    = flightInfo.departureDate;
// 							var depDayTxt  = week[new Date(depDate.substring(0,4) + '-' + depDate.substring(4,6) + '-' + depDate.substring(6,8)).getDay()];
							var depDayTxt  = getDayByLang(depDate.substring(0,8), 'KO')
							var depDateTxt = depDate.substring(0,4) + '.' + depDate.substring(4,6) + '.' + depDate.substring(6,8) + '(' + depDayTxt + ')';
							var flightTm   = flightInfo.flyingTime;

							var depArrDateTxt = "출도착시간";
							var flightNoTxt = "편명/기종";
							var taskTxt =  "좌석배정/체크인" ;
							var strongTxt = flightInfo.carrierCode + flightInfo.flightNo + "여정" ;
							
							layerHtml += '<dt>\
											<div class="fl location">\
												<span>' + flightInfo.carrierCode + flightInfo.flightNo + '</span>\
											</div>\
											<div class="fr">\
												<span class="date mar_ri30">' + depDateTxt + '</span>\
											</div>\
										</dt>\
										<dd class="on">\
											<table class="table_list tb_flight_info" id="tb_segmentTask' + targetCnt + '">\
												<caption>\
												...
												<thead>\
													<tr>\
														<th scope="col">' + depArrDateTxt + '</th>\
														<th scope="col">' + flightNoTxt + '</th>\
														<th scope="col">' + taskTxt + '</th>\
													</tr>\
												</thead>\
												<tbody>\
													<tr>\
														<td class="vertical_mid">\
															<div class="flight_time">\
																<ul>\
																	<li>\
																		<p class="title">' + flightInfo.departureAirportDesc + '</p>\
																		<p class="time">' + flightInfo.departureDate.substring(8,10) + ':' + flightInfo.departureDate.substring(10,12) + '</p>\
																	</li>\
																	<li class="direct">\
																		<p class="lead_time"></p>\
																		<p class="course direct"></p>\
																	</li>\
																	<li>\
																		<p class="title">' + flightInfo.arrivalAirportDesc + '</p>\
																		<p class="time">' + flightInfo.arrivalDate.substring(8,10) + ':' + flightInfo.arrivalDate.substring(10,12) + '</p>';
							if((flightInfo.arrivalDate.substring(0,8) - flightInfo.departureDate.substring(0,8)) > 0){
								layerHtml += '							<p class="nextday">+' + (flightInfo.arrivalDate.substring(0,8) - flightInfo.departureDate.substring(0,8)) + 'DAY</p>';
							}
							layerHtml += '							</li>\
																</ul>\
															</div>\
														...
														<td>\
															<a href="javascript:;" id="flight_name_'+(i+j)+'" class="flight_name" fltno="'+flightInfo.flightNo+'" fltcrrcd="'+flightInfo.carrierCode+'" fltDepAirport="'+flightInfo.departureAirport+'" fltdate="'+flightInfo.departureDate+'" strcraftTp="'+flightInfo.aircraftType+'">\
															    <span>' + flightInfo.carrierCode + flightInfo.flightNo + '</span>\
															</a>\
															<div class="plane_species">' + flightInfo.aircraftType + '</div>\
														</td>\
														<td>\
															<button type="button" id="btn_checkIn_' + (i+j) + '" name="btn_checkIn" class="btn_M red" ' + btnAttr + '">' + btnText + '</button>\
														</td>\
													</tr>\
												</tbody>\
											</table>\
				...
				if(targetCnt > 1) {
					if(preSeatCnt == allFltCnt) { 
						...
						var $div_checkInFlight_id	= $('#div_checkInFlight');
						$div_checkInFlight_id.empty();
						$div_checkInFlight_id.append(layerHtml);
						result = "MULTI_SEG";

						
						for(var i = 0 ; i < targetCnt ; i++) {
							tableCaption('#tb_segmentTask' + (i + 1));
						}
			...
			function setExistSeatOrACILayer(pnrData, existSeatOrACI) {
				var segDatas = pnrData.segmentDatas;
				var pnrAlpha = pnrData.pnrAlpha;
				var bizType = pnrData.bizType;
				var officeId = pnrData.officeId;
				...
				if(existSeatOrACI){
					...
					$('dl[id^=dl_existSeatOrACI_toggle_]').each(function() {
					...
					for(var i = 0 ; i < segDatas.length ; i++){
						for(var j = 0 ; j < segDatas[i].flightInfoDatas.length ; j++){
							...
							if(flightInfo.carrierCode === 'OZ' && (flightInfo.operationCarrierCode === '' || flightInfo.operationCarrierCode === 'OZ') && flightInfo.checkInType === 'S'){
								if(divToggleCnt > 0){
									var cloneDiv = $('#dl_existSeatOrACI_toggle_1').clone();

									cloneDiv.find('[id^=tb_existSeatOrACI]').attr('id' , 'tb_existSeatOrACI' + (divToggleCnt + 1));
									cloneDiv.find('span[id^=span_flightInfo]').attr('id' , 'span_flightInfo' + (divToggleCnt + 1));
									cloneDiv.find('[id^=check]').attr('id' , 'check' + (divToggleCnt + 1));
									cloneDiv.find('[id^=lb_check]').attr('for' , 'check' + (divToggleCnt + 1));
									cloneDiv.find('[id^=lb_check]').attr('id' , 'lb_check' + (divToggleCnt + 1));


									$(cloneDiv).attr('id' , 'dl_existSeatOrACI_toggle_' + parseInt(divToggleCnt + 1));
									var prevDiv = $('dl[id^=dl_existSeatOrACI_toggle_]')[$('dl[id^=dl_existSeatOrACI_toggle_]').length - 1];
									$(prevDiv).after(cloneDiv);
								}
								divToggleCnt++;
								var currentDiv = $('dl[id^=dl_existSeatOrACI_toggle_]')[$('dl[id^=dl_existSeatOrACI_toggle_]').length - 1];
...
// 								var flightDate = depYear + '.' + depMonth + '.' + depDay + ' (' + week[depDate.getDay()] + ')';
								var flightDate = depYear + '.' + depMonth + '.' + depDay + '(' + getDayByLang(flightInfo.departureDate.substring(0,8), 'KO') + ')';
								$(currentDiv).find('span[id^=span_flightInfo]').html(flightInfo.carrierCode + flightInfo.flightNo + ' ' + flightInfo.aircraftType);
								$(currentDiv).find('span[id=span_flightDate]').html(flightDate);
								$(currentDiv).find('span[id=span_flightDepAirport]').html(flightInfo.departureAirportDesc);
								$(currentDiv).find('span[id=span_flightArrAirport]').html(flightInfo.arrivalAirportDesc);

								$(currentDiv).find('tbody[id=tbody_existSeatOrACI]').empty();
								...
								for(var k = 0 ; k < passengerDatas.length ; k++){
									...
									var passengerACITxt = passengerData.existACI ? "<strong class='col_brown'>오토체크인 신청 완료</strong>" : "<span class='col_gray'>오토체크인 신청 가능</span>";
									var tooltipTxt      = passengerData.existACI ? "오토체크인 신청 완료" : "간단한 정보 입력 후 출발 24시간 전에 미리 탑승권을 받고 공항에서의 대기시간을 줄여보세요~";
									...
									var htmlExistSeatOrACI = "<tr>"
													...
													+ "            <a href='#none' class='btn_info' id='a_existSeatOrACILayerTooltip'>도움말</a>"
													+ "            <div class='layer_tooltip type2 left' style='width:270px;' id='div_existSeatOrACILayerTooltip'>"
													+ "                <div class='inner'>"
													+ "                    <p class='desc'>" + tooltipTxt + "</p>"
													+ "                    <p class='desc'>(단, 모바일 탑승권이 허용되지 않는 일부 해외공항에서는 탑승권 전송이 제한될 수 있습니다.)</p>"
													+ "                </div>"
													...
													+ "    </td>"
													+ "</tr>";
									$(currentDiv).find('tbody[id=tbody_existSeatOrACI]').append(htmlExistSeatOrACI);
					...
					$('table[id^=tb_existSeatOrACI]').each(function(){
						var thisId   = $(this).attr('id');
						var thisIdx = thisId.replace('tb_existSeatOrACI' , '');
						tableCaption('#' + thisId);
						var captionStrong = $(this).find('caption').find('strong');
						captionStrong.html($('#span_flightInfo' + thisIdx).html() + "좌석배정/오토체크인 신청내역 표"); 
					})
				}
			};
			...
			var showBlockLayer = function showBlockLayer(processType, clickId, callBack) {
				var $div_checkInImpossible_id		= $("#div_checkInImpossible");
				var $div_onlineReservImpossible_id	= $("#div_onlineReservImpossible");
				$('body').css('overflow-y' , 'hidden');
				$('#id_InfAndGroupCase').hide();
				$('#idOnlySeatMapCase').hide();
				if(processType == "ONLY_SEAT") {
					$('#idOnlySeatMapCase').show();
					$("#btnGoSeatMap").show();
					$("#btnGoSeatMap").off("click").on("click" , function() {
					...
					$("#btnGoSeatMap").hide();
					$("#btnGoSeatMap").off("click");
				}

				openLayerPopup('div_checkInImpossible', clickId);
// 				$div_checkInImpossible_id.show();
// 				$div_onlineReservImpossible_id.show();
				var impossibleCenterTop = $(window).height()/2 - $div_checkInImpossible_id.find(".layer_pop").height()/2;
				impossibleCenterTop = impossibleCenterTop + "px";
				$("#div_checkInImpossible").find(".layer_pop").css({position:"fixed", top:impossibleCenterTop, left:"0%"});
			};

			
			var setCheckIn = function setCheckIn(departureDate, pnrAlpha) {
				
				action_logging({_n_m09:"checkin"});

				var webApp = "PCWeb";
				var checkinDate	= moment(departureDate, "YYYYMMDDHHmmss").format("DD/MM/YYYY");
				$('#IDepartureDate').val(checkinDate);
				$('#IIdentificationBookingRef').val(pnrAlpha);
				$('#channel').val(webApp);
				$('#checkInFrm').attr({
					'target' : 'popup',
					'action' : 'https://checkin.si.amadeus.net/1ASIHSSCWEBOZ/sscwoz/checkindirect'
				}).submit();
			};

			
			var setPreferredSeatsOrAutoCheckIn = function setPreferredSeatsOrAutoCheckIn(bizType, officeId, pnrAlpha, pnrNumeric, lastName, nextPage) {
				generateUUID();
				var sessionUniqueKey = document.getElementById('sessionUniqueKey').value;
				var failAlertMsg = nextPage === "AutoCheckIn" ? "오토체크인 페이지 이동에 실패했습니다." : "좌석배정 페이지 이동에 실패했습니다.";
				

				$.ajax({
					url			: 'RetrievePNRForAddService.do',
					type		: 'POST',
					dataType	: 'json',
					data		: {
						bizType				: bizType,
					...
					success		: function(data) {
						...
						if(typeof data.bizType == 'undefined' ||  data.bizType == '') {
							alert(failAlertMsg);
							return;
						}else{
	...
	<script type="text/javascript">var _cf = _cf || []; _cf.push(['_setFsp', true]); _cf.push(['_setBm', true]); _cf.push(['_setAu', '/public/40fecf9061576a410e665f8135125']);</script><script type="text/javascript" src="/public/40fecf9061576a410e665f8135125"></script>
<script type="text/javascript" src="/wlo/wl6.js"></script><div style="background-color: rgb(255, 255, 255); border: 1px solid rgb(204, 204, 204); box-shadow: rgba(0, 0, 0, 0.2) 2px 2px 3px; position: absolute; transition: visibility 0s linear 0.3s, opacity 0.3s linear 0s; opacity: 0; visibility: hidden; z-index: 2000000000; left: 0px; top: -10000px;"><div style="width: 100%; height: 100%; position: fixed; top: 0px; left: 0px; z-index: 2000000000; background-color: rgb(255, 255, 255); opacity: 0.05;"></div><div class="g-recaptcha-bubble-arrow" style="border: 11px solid transparent; width: 0px; height: 0px; position: absolute; pointer-events: none; margin-top: -11px; z-index: 2000000000;"></div><div class="g-recaptcha-bubble-arrow" style="border: 10px solid transparent; width: 0px; height: 0px; position: absolute; pointer-events: none; margin-top: -10px; z-index: 2000000000;"></div><div style="z-index: 2000000000; position: relative;"><iframe title="reCAPTCHA 보안문자" src="https://www.google.com/recaptcha/api2/bframe?hl=ko&amp;v=A1Aard-wURuGsXRGA7JMOqVO&amp;k=6LcyoDwUAAAAAG42mLWkJPNAs35QRLvnl2O0xOCJ&amp;cb=9n0ccgxwj7vq" name="c-sqpi35n32am6" frameborder="0" scrolling="no" sandbox="allow-forms allow-popups allow-same-origin allow-scripts allow-top-navigation allow-modals allow-popups-to-escape-sandbox" style="width: 100%; height: 100%;"></iframe></div></div></body></html>